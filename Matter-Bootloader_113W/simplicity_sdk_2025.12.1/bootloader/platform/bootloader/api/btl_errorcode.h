...
/// GPIO retention errors
#define BOOTLOADER_ERROR_GPIO_RETENTION_BASE        0x1500L
...
/**
 * @addtogroup ParseError Parse Error Codes
...
/**
 * @addtogroup GpioRetentionError GPIO Retention Error Codes
 * @brief Bootloader error codes returned by GPIO retention operations.
 * @details
 *    Offset from @ref BOOTLOADER_ERROR_GPIO_RETENTION_BASE
 * @{
 */
/// GPIO retention validation failed (invalid signature, pin configuration, etc.)
#define BOOTLOADER_ERROR_GPIO_RETENTION_INVALID \
  (BOOTLOADER_ERROR_GPIO_RETENTION_BASE | 0x01L)
/** @} addtogroup GpioRetentionError */
