...
#if (defined(SL_MATTER_RGB_LED_ENABLED) && SL_MATTER_RGB_LED_ENABLED == 1)
    void PostLightControlActionRequest(int32_t aActor, LightingManager::Action_t aAction, const RGBLEDWidget::ColorData_t & aValue);
...
private:
    ...
    static void LightSwitchButtonEventHandler(AppEvent * aEvent);

    static void OnButtonPressed();
    static void OnButtonReleased();
    static void HandleSingleClick();
    static void HandleDoubleClick();
    static void HandleLongPressTick();
    static void StartEffect(EffectMode mode);
    static void StopEffect();
    static void RunEffectStep();
    static void ApplyWhiteEffectLevel(uint8_t level);
    static void StartCommissioningWindow();
    static void StopCommissioningWindow();
    static void RestartCommissioningTimer();
    ...
    static osTimerId_t sClickTimer;
    static osTimerId_t sLongPressTimer;
    static osTimerId_t sEffectTimer;
    static osTimerId_t sPostResetWindowTimer;
    static osTimerId_t sBootDefaultTimer;
    static osTimerId_t sIdentifyTimer;
    static osTimerId_t sResetOffTimer;
};
