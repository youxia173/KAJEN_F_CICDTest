...
// Keep only error-level stack logs; functional dimming logs are emitted with ChipLogError.
...
// Enable Silicon Labs platform logging so RTT/UART output is initialized
