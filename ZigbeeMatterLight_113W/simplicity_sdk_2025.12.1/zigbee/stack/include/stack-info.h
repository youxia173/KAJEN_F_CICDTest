...
/** @brief Return the number of supported networks.
 *
 * @return The number of supported networks.
 */
uint8_t sl_zigbee_get_supported_networks(void);

/** @brief Return the key table size.
 *
 * @return The key table size.
 */
uint8_t sl_zigbee_get_key_table_size(void);

/** @brief Return the child table size.
 *
 * @return The child table size.
 */
uint8_t sl_zigbee_get_child_table_size(void);

/** @brief Return the coordinator and router count.
 *
 * @return The coordinator and router count.
 */
uint8_t sl_zigbee_get_zc_and_zr_count(void);

/** @brief Return the certificate table size.
 *
 * @return The certificate table size.
 */
