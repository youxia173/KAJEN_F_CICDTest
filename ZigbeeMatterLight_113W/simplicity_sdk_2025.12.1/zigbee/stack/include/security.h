...
/** @brief Send a Verify Key command to the partner device to verify the partner link key between the two devices.
 *
 * @param shortID Partner's short ID
 * @param eui Partner's EUI64
 *
 * @return ::SL_STATUS_OK, SL_STATUS_INVALID_STATE, SL_STATUS_ALLOCATION_FAILED
 */
sl_status_t sl_zigbee_verify_partner_link_key(sl_802154_short_addr_t shortID, sl_802154_long_addr_t eui);
