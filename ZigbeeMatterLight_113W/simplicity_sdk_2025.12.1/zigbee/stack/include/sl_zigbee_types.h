...
#endif
{
  ...
  /** FOR TESTING ONLY: leave without broadcasting a Network Leave */
  // This used to be the REMOVE_CHILDREN bit. We use this bit now only for testing. Only
  // CLI commands ever set this bit; we clear this bit on received over-the-air packets.
  SL_ZIGBEE_LEAVE_NWK_SILENTLY            = 0x80,
};
