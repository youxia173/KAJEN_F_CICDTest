...
sl_status_t sli_zigbee_stack_get_key_from_install_code(sl_zigbee_key_data_t *key);
...
sl_status_t slxi_zigbee_stack_get_key_table_additional_info(uint8_t index,
                                                            uint32_t *tok);

sl_status_t slxi_zigbee_stack_get_trust_center_additional_info(uint32_t *tok);

sl_status_t slxi_zigbee_stack_set_key_table_additional_info(uint8_t index,
                                                            uint32_t tok);
