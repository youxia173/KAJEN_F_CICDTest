...
#endif
#ifdef SL_CATALOG_ZIGBEE_MEMORY_USAGE_PRESENT
...
typedef struct {
  union {
    ...
    #endif
    #ifdef SL_CATALOG_HIGH_DATARATE_PHY_PRESENT
    sli_mac_stack_force_tx_after_failed_hdr_phy_cca_ipc_msg_t force_tx_after_failed_hdr_phy_cca;
    ...
    sli_zigbee_stack_get_certificate_table_size_ipc_msg_t get_certificate_table_size;
    sli_zigbee_stack_get_child_table_size_ipc_msg_t get_child_table_size;
    ...
    sli_zigbee_stack_get_key_table_size_ipc_msg_t get_key_table_size;
    ...
    sli_zigbee_stack_get_supported_networks_ipc_msg_t get_supported_networks;
    sli_zigbee_stack_get_zc_and_zr_count_ipc_msg_t get_zc_and_zr_count;
    ...
    slxi_zigbee_stack_get_key_table_additional_info_ipc_msg_t get_key_table_additional_info;
