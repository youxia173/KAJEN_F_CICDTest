...
typedef struct {
  uint8_t result;
} sli_zigbee_stack_get_certificate_table_size_ipc_rsp_t;

typedef struct {
  sli_zigbee_stack_get_certificate_table_size_ipc_rsp_t response;
} sli_zigbee_stack_get_certificate_table_size_ipc_msg_t;

typedef struct {
  uint8_t result;
} sli_zigbee_stack_get_child_table_size_ipc_rsp_t;

typedef struct {
  sli_zigbee_stack_get_child_table_size_ipc_rsp_t response;
} sli_zigbee_stack_get_child_table_size_ipc_msg_t;
...
typedef struct {
  uint8_t result;
} sli_zigbee_stack_get_key_table_size_ipc_rsp_t;

typedef struct {
  sli_zigbee_stack_get_key_table_size_ipc_rsp_t response;
} sli_zigbee_stack_get_key_table_size_ipc_msg_t;
...
typedef struct {
  uint8_t result;
} sli_zigbee_stack_get_supported_networks_ipc_rsp_t;

typedef struct {
  sli_zigbee_stack_get_supported_networks_ipc_rsp_t response;
} sli_zigbee_stack_get_supported_networks_ipc_msg_t;

typedef struct {
  uint8_t result;
} sli_zigbee_stack_get_zc_and_zr_count_ipc_rsp_t;

typedef struct {
  sli_zigbee_stack_get_zc_and_zr_count_ipc_rsp_t response;
} sli_zigbee_stack_get_zc_and_zr_count_ipc_msg_t;
