...
} sli_zigbee_stack_get_key_from_install_code_ipc_req_t;

typedef struct {
  sl_status_t result;
} sli_zigbee_stack_get_key_from_install_code_ipc_rsp_t;

typedef struct {
  sli_zigbee_stack_get_key_from_install_code_ipc_req_t request;
  sli_zigbee_stack_get_key_from_install_code_ipc_rsp_t response;
} sli_zigbee_stack_get_key_from_install_code_ipc_msg_t;
...
typedef struct {
  uint8_t index;
  uint32_t tok;
} slxi_zigbee_stack_get_key_table_additional_info_ipc_req_t;

typedef struct {
  sl_status_t result;
} slxi_zigbee_stack_get_key_table_additional_info_ipc_rsp_t;

typedef struct {
  slxi_zigbee_stack_get_key_table_additional_info_ipc_req_t request;
  slxi_zigbee_stack_get_key_table_additional_info_ipc_rsp_t response;
} slxi_zigbee_stack_get_key_table_additional_info_ipc_msg_t;

typedef struct {
  uint32_t tok;
} slxi_zigbee_stack_get_trust_center_additional_info_ipc_req_t;

typedef struct {
  sl_status_t result;
} slxi_zigbee_stack_get_trust_center_additional_info_ipc_rsp_t;

typedef struct {
  slxi_zigbee_stack_get_trust_center_additional_info_ipc_req_t request;
  slxi_zigbee_stack_get_trust_center_additional_info_ipc_rsp_t response;
} slxi_zigbee_stack_get_trust_center_additional_info_ipc_msg_t;

typedef struct {
  uint8_t index;
  uint32_t tok;
} slxi_zigbee_stack_set_key_table_additional_info_ipc_req_t;

typedef struct {
  sl_status_t result;
} slxi_zigbee_stack_set_key_table_additional_info_ipc_rsp_t;

typedef struct {
  slxi_zigbee_stack_set_key_table_additional_info_ipc_req_t request;
  slxi_zigbee_stack_set_key_table_additional_info_ipc_rsp_t response;
} slxi_zigbee_stack_set_key_table_additional_info_ipc_msg_t;

typedef struct {
  uint32_t tok;
} slxi_zigbee_stack_set_trust_center_additional_info_ipc_req_t;

typedef struct {
  sl_status_t result;
} slxi_zigbee_stack_set_trust_center_additional_info_ipc_rsp_t;

typedef struct {
  slxi_zigbee_stack_set_trust_center_additional_info_ipc_req_t request;
  slxi_zigbee_stack_set_trust_center_additional_info_ipc_rsp_t response;
} slxi_zigbee_stack_set_trust_center_additional_info_ipc_msg_t;
