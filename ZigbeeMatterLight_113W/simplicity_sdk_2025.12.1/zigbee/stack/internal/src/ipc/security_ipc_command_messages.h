...
typedef struct {
  sl_status_t result;
} sli_zigbee_stack_update_app_link_key_ipc_rsp_t;

typedef struct {
  sli_zigbee_stack_update_app_link_key_ipc_req_t request;
  sli_zigbee_stack_update_app_link_key_ipc_rsp_t response;
} sli_zigbee_stack_update_app_link_key_ipc_msg_t;
...
} sli_zigbee_stack_verify_partner_link_key_ipc_req_t;

typedef struct {
  sl_status_t result;
} sli_zigbee_stack_verify_partner_link_key_ipc_rsp_t;

typedef struct {
  sli_zigbee_stack_verify_partner_link_key_ipc_req_t request;
  sli_zigbee_stack_verify_partner_link_key_ipc_rsp_t response;
} sli_zigbee_stack_verify_partner_link_key_ipc_msg_t;
