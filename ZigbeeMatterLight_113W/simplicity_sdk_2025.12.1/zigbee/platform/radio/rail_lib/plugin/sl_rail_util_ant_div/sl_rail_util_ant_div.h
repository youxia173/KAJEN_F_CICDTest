 ...
 *
 * This macro checks if antenna diversity is enabled by invoking
 * sl_rail_util_ant_div_get_phy_select(). If the antenna diversity is active,
 * it returns SL_RAIL_IEEE802154_PHY_FEATURE_2P4_GHZ_ANT_DIV. Otherwise, it returns
 * SL_RAIL_IEEE802154_PHY_FEATURE_2P4_GHZ.
 *
 * @return The appropriate 2.4 GHz PHY feature flag based on the current antenna configuration.
 */
#define sl_rail_util_ant_div_get_phy_features() (sl_rail_util_ant_div_get_phy_select()            \
