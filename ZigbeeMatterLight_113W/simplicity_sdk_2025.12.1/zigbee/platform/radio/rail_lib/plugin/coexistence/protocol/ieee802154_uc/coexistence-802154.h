...
/**
 * @brief Defines the runtime PHY features for 2.4 GHz with coexistence.
 *
 * This macro conditionally selects between coexistence-optimized and standard PHY features
 * based on the SL_RAIL_UTIL_COEX_RUNTIME_PHY_SELECT configuration:
 *
 * - When SL_RAIL_UTIL_COEX_RUNTIME_PHY_SELECT is defined: Uses coexistence-optimized PHY
 *   (SL_RAIL_IEEE802154_PHY_FEATURE_2P4_GHZ_COEX)
 * - When SL_RAIL_UTIL_COEX_RUNTIME_PHY_SELECT is not defined: Uses standard PHY
 *   (SL_RAIL_IEEE802154_PHY_FEATURE_2P4_GHZ)
 *
 * This allows applications to dynamically choose between PHY configurations at compile time.
 */
#if SL_RAIL_UTIL_COEX_RUNTIME_PHY_SELECT
#define SL_RAIL_UTIL_IEEE802154_RUNTIME_PHY_FEATURES_2P4_COEX \
  SL_RAIL_IEEE802154_PHY_FEATURE_2P4_GHZ_COEX
#else
#define SL_RAIL_UTIL_IEEE802154_RUNTIME_PHY_FEATURES_2P4_COEX \
  SL_RAIL_IEEE802154_PHY_FEATURE_2P4_GHZ
...
/**
 * @brief Defines the default PHY features for 2.4 GHz with coexistence.
 *
 * This macro sets the default PHY feature configuration for the 2.4 GHz band
 * when coexistence is applied, using SL_RAIL_IEEE802154_PHY_FEATURE_2P4_GHZ.
 */
#define SL_RAIL_UTIL_IEEE802154_DEFAULT_PHY_FEATURES_2P4_COEX \
  SL_RAIL_IEEE802154_PHY_FEATURE_2P4_GHZ

/**
 * @brief Retrieves the coexistence PHY features for 2.4 GHz.
 *
 * This macro evaluates whether coexistence-specific PHY features should be used by checking
 * if sl_rail_util_coex_is_coex_phy_selected() returns true. If so, it returns the
 * coexistence-specific PHY feature set (SL_RAIL_IEEE802154_PHY_FEATURE_2P4_GHZ_COEX);
 * otherwise, it returns the default coexistence PHY feature set (SL_RAIL_IEEE802154_PHY_FEATURE_2P4_GHZ).
 */
#define sl_rail_util_ieee802154_get_coex_phy_features() (sl_rail_util_coex_is_coex_phy_selected()      \
                                                         ? SL_RAIL_IEEE802154_PHY_FEATURE_2P4_GHZ_COEX \
                                                         : SL_RAIL_IEEE802154_PHY_FEATURE_2P4_GHZ)
...
// Return whether COEX optimized PHY is selected
...
// Return whether Radio Hold-Off is enabled
