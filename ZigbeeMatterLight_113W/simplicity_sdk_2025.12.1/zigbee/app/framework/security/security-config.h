...
// Z4 security.
#define SL_ZIGBEE_AF_SECURITY_PROFILE_Z4_TC_SECURITY_BITMASK            (SL_ZIGBEE_TRUST_CENTER_GLOBAL_LINK_KEY \
                                                                         | SL_ZIGBEE_HAVE_PRECONFIGURED_KEY     \
                                                                         | SL_ZIGBEE_HAVE_NETWORK_KEY           \
                                                                         | SL_ZIGBEE_NO_FRAME_COUNTER_RESET     \
                                                                         | SL_ZIGBEE_REQUIRE_ENCRYPTED_KEY)
#define SL_ZIGBEE_AF_SECURITY_PROFILE_Z4_TC_EXTENDED_SECURITY_BITMASK   SL_ZIGBEE_NWK_LEAVE_REQUEST_NOT_ALLOWED
#define SL_ZIGBEE_AF_SECURITY_PROFILE_Z4_NODE_SECURITY_BITMASK          (SL_ZIGBEE_TRUST_CENTER_GLOBAL_LINK_KEY \
                                                                         | SL_ZIGBEE_HAVE_PRECONFIGURED_KEY     \
                                                                         | SL_ZIGBEE_REQUIRE_ENCRYPTED_KEY      \
                                                                         | SL_ZIGBEE_NO_FRAME_COUNTER_RESET)
#define SL_ZIGBEE_AF_SECURITY_PROFILE_Z4_NODE_EXTENDED_SECURITY_BITMASK (SL_ZIGBEE_JOINER_GLOBAL_LINK_KEY \
                                                                         | SL_ZIGBEE_EXT_NO_FRAME_COUNTER_RESET)
#define SL_ZIGBEE_AF_SECURITY_PROFILE_Z4_TC_LINK_KEY_REQUEST_POLICY     SL_ZIGBEE_AF_DENY_TC_KEY_REQUESTS
#define SL_ZIGBEE_AF_SECURITY_PROFILE_Z4_APP_LINK_KEY_REQUEST_POLICY    SL_ZIGBEE_AF_DENY_APP_KEY_REQUESTS
#define SL_ZIGBEE_AF_SECURITY_PROFILE_Z4_PRECONFIGURED_KEY              ZIGBEE_PROFILE_INTEROPERABILITY_LINK_KEY
