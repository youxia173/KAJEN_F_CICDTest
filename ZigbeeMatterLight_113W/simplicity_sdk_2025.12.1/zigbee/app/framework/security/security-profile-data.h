...
#endif
#ifdef SL_ZIGBEE_AF_HAS_SECURITY_PROFILE_Z4
{
  SL_ZIGBEE_AF_SECURITY_PROFILE_Z4,
  SL_ZIGBEE_AF_SECURITY_PROFILE_Z4_TC_SECURITY_BITMASK,
  SL_ZIGBEE_AF_SECURITY_PROFILE_Z4_TC_EXTENDED_SECURITY_BITMASK,
  SL_ZIGBEE_AF_SECURITY_PROFILE_Z4_NODE_SECURITY_BITMASK,
  SL_ZIGBEE_AF_SECURITY_PROFILE_Z4_NODE_EXTENDED_SECURITY_BITMASK,
  SL_ZIGBEE_AF_SECURITY_PROFILE_Z4_TC_LINK_KEY_REQUEST_POLICY,
  SL_ZIGBEE_AF_SECURITY_PROFILE_Z4_APP_LINK_KEY_REQUEST_POLICY,
  SL_ZIGBEE_AF_SECURITY_PROFILE_Z4_PRECONFIGURED_KEY,
},
#endif
