 ...
 */
WEAK(void sl_zigbee_af_add_to_current_app_tasks_cb(sl_zigbee_af_application_task_t tasks))
{
  (void)tasks;
}
 ...
 */
WEAK(sl_zigbee_af_attribute_write_permission_t sl_zigbee_af_allow_network_write_attribute_cb(int8u endpoint,
                                                                                             ...
                                                                                             int8u type))
{
  ...
  (void)value;
  (void)type;
  return SL_ZIGBEE_ZCL_ATTRIBUTE_WRITE_PERMISSION_ALLOW_WRITE_NORMAL; // Default
}
 ...
 * @param attributeId   Ver.: always
 */
WEAK(bool sl_zigbee_af_attribute_read_access_cb(int8u endpoint,
                                                sl_zigbee_af_cluster_id_t clusterId,
                                                int16u manufacturerCode,
                                                int16u attributeId))
{
 ...
 * @param attributeId   Ver.: always
 */
WEAK(bool sl_zigbee_af_attribute_write_access_cb(int8u endpoint,
                                                 sl_zigbee_af_cluster_id_t clusterId,
                                                 int16u manufacturerCode,
                                                 int16u attributeId))
{
 ...
 *
 */
WEAK(sl_status_t sl_zigbee_af_clear_report_table_cb(void))
{
 ...
 * @param clusterId   Ver.: always
 */
WEAK(void sl_zigbee_af_cluster_init_cb(int8u endpoint,
                                       sl_zigbee_af_cluster_id_t clusterId))
{
  (void)endpoint;
  (void)clusterId;
 ...
 */
WEAK(bool sl_zigbee_af_cluster_security_custom_cb(sl_zigbee_af_profile_id_t profileId,
                                                  sl_zigbee_af_cluster_id_t clusterId,
                                                  bool incoming,
                                                  int8u commandId))
{
 ...
 */
WEAK(bool sl_zigbee_af_configure_reporting_command_cb(const sl_zigbee_af_cluster_command_t *cmd))
{
  (void)cmd;
  return false;
}
 ...
 */
WEAK(bool sl_zigbee_af_configure_reporting_response_cb(sl_zigbee_af_cluster_id_t clusterId,
                                                       int8u *buffer,
                                                       int16u bufLen))
{
  (void)clusterId;
 ...
 */
WEAK(bool sl_zigbee_af_default_response_cb(sl_zigbee_af_cluster_id_t clusterId,
                                           int8u commandId,
 ...
 * not.  Ver.: always
 */
WEAK(bool sl_zigbee_af_discover_attributes_response_cb(sl_zigbee_af_cluster_id_t clusterId,
 ...
 */
WEAK(bool sl_zigbee_af_discover_commands_generated_response_cb(sl_zigbee_af_cluster_id_t clusterId,
                                                               int16u manufacturerCode,
                                                               bool discoveryComplete,
                                                               int8u *commandIds,
 ...
 * the number of identifiers.  Ver.: always
 */
WEAK(bool sl_zigbee_af_discover_commands_received_response_cb(sl_zigbee_af_cluster_id_t clusterId,
                                                              int16u manufacturerCode,
                                                              bool discoveryComplete,
                                                              int8u *commandIds,
                                                              int16u commandIdCount))
 ...
 *
 */
WEAK(void sl_zigbee_af_eeprom_init_cb(void))
{
}
 ...
 */
WEAK(void sl_zigbee_af_eeprom_note_initialized_state_cb(bool state))
{
  (void)state;
}
 ...
 *
 */
WEAK(void sl_zigbee_af_eeprom_shutdown_cb(void))
{
}
 ...
 */
WEAK(sl_zigbee_af_status_t sl_zigbee_af_external_attribute_read_cb(int8u endpoint,
                                                                   sl_zigbee_af_cluster_id_t clusterId,
 ...
 * @param buffer   Ver.: always
 */
WEAK(sl_zigbee_af_status_t sl_zigbee_af_external_attribute_write_cb(int8u endpoint,
                                                                    sl_zigbee_af_cluster_id_t clusterId,
                                                                    sl_zigbee_af_attribute_metadata_t *attributeMetadata,
                                                                    int16u manufacturerCode,
                                                                    int8u *buffer))
 ...
 *
 */
WEAK(sl_status_t sl_zigbee_af_find_unused_pan_id_and_form_cb(void))
{
  return SL_STATUS_NOT_AVAILABLE;
}
 ...
 *
 */
WEAK(sl_zigbee_af_application_task_t sl_zigbee_af_get_current_app_tasks_cb(void))
{
  return 0;
}
 ...
 *
 */
WEAK(sl_zigbee_af_event_poll_control_t sl_zigbee_af_get_current_poll_control_cb(void))
{
  return SL_ZIGBEE_AF_LONG_POLL;
}
 ...
 *
 */
WEAK(int32u sl_zigbee_af_get_current_poll_interval_ms_cb(void))
{
  return 0;
}
 ...
 *
 */
WEAK(int32u sl_zigbee_af_get_current_poll_interval_qs_cb(void))
{
  return 0;
}
 ...
 *
 */
WEAK(sl_zigbee_af_event_sleep_control_t sl_zigbee_af_get_current_sleep_control_cb(void))
{
  return SL_ZIGBEE_AF_OK_TO_SLEEP;
}
 ...
 *
 */
WEAK(int32u sl_zigbee_af_get_current_time_cb(void))
{
  return 0;
}
 ...
 *
 */
WEAK(sl_zigbee_af_event_poll_control_t sl_zigbee_af_get_default_poll_control_cb(void))
{
  return SL_ZIGBEE_AF_LONG_POLL;
}
 ...
 *
 */
WEAK(sl_zigbee_af_event_sleep_control_t sl_zigbee_af_get_default_sleep_control_cb(void))
{
  return SL_ZIGBEE_AF_OK_TO_SLEEP;
}
 ...
 */
WEAK(bool sl_zigbee_af_get_endpoint_by_index_cb(int8u index,
 ...
 * always
 */
WEAK(bool sl_zigbee_af_get_endpoint_description_cb(int8u endpoint,
 ...
 */
WEAK(bool sl_zigbee_af_get_endpoint_info_cb(int8u endpoint,
                                            int8u* returnNetworkIndex,
                                            sl_zigbee_af_endpoint_info_struct_t* returnEndpointInfo))
{
  (void)endpoint;
  (void)returnNetworkIndex;
  (void)returnEndpointInfo;
  return false;
}
 ...
 */
WEAK(void sl_zigbee_af_get_form_and_join_extended_pan_id_cb(int8u *resultLocation))
{
  (void)resultLocation;
}
 ...
 *
 */
WEAK(int32u sl_zigbee_af_get_long_poll_interval_ms_cb(void))
{
  return 0;
}
 ...
 *
 */
WEAK(int32u sl_zigbee_af_get_long_poll_interval_qs_cb(void))
{
  return 0;
}
 ...
 *
 */
WEAK(int16u sl_zigbee_af_get_short_poll_interval_ms_cb(void))
{
  return 0;
}
 ...
 *
 */
WEAK(int16u sl_zigbee_af_get_short_poll_interval_qs_cb(void))
{
  return 0;
}
 ...
 *
 */
WEAK(sl_zigbee_af_application_task_t sl_zigbee_af_get_wake_timeout_bitmask_cb(void))
{
  return 0;
}
 ...
 *
 */
WEAK(int16u sl_zigbee_af_get_wake_timeout_ms_cb(void))
{
  return 0;
}
 ...
 *
 */
WEAK(int16u sl_zigbee_af_get_wake_timeout_qs_cb(void))
{
  return 0;
}
 ...
 */
WEAK(void sl_zigbee_af_hal_button_isr_cb(int8u button,
                                         int8u state))
{
  (void)button;
  (void)state;
 ...
 */
WEAK(sl_status_t sl_zigbee_af_initiate_inter_pan_key_establishment_cb(sl_802154_pan_id_t panId,
 ...
 */
WEAK(sl_status_t sl_zigbee_af_initiate_key_establishment_cb(sl_802154_short_addr_t nodeId,
                                                            int8u endpoint))
{
  (void)nodeId;
  (void)endpoint;
 ...
 */
WEAK(sl_status_t sl_zigbee_af_initiate_partner_link_key_exchange_cb(sl_802154_short_addr_t target,
                                                                    int8u endpoint,
 ...
 */
WEAK(bool sl_zigbee_af_inter_pan_key_establishment_cb(sl_zigbee_af_key_establishment_notify_message_t status,
                                                      bool amInitiator,
 ...
 */
WEAK(sl_status_t sl_zigbee_af_interpan_send_message_cb(sl_zigbee_af_interpan_header_t* header,
 ...
 * @param delayInSeconds   Ver.: always
 */
WEAK(bool sl_zigbee_af_key_establishment_cb(sl_zigbee_af_key_establishment_notify_message_t status,
                                            bool amInitiator,
 ...
 */
WEAK(bool sl_zigbee_af_main_start_cb(int* returnCode,
                                     int argc,
                                     char** argv))
{
  (void)returnCode;
 ...
 *
 */
WEAK(void sl_zigbee_af_ncp_init_cb(void))
{
}
 ...
 *
 */
WEAK(void sl_zigbee_af_ncp_is_awake_isr_cb(void))
{
}
 ...
 * @param status   Ver.: always
 */
WEAK(void sl_zigbee_af_network_key_update_complete_cb(sl_status_t status))
{
  (void)status;
}
 ...
 */
WEAK(int8u sl_zigbee_af_ota_bootload_cb(const sl_zigbee_af_ota_image_id_t* id,
                                        int16u ncpUpgradeTagId))
{
  (void)id;
  (void)ncpUpgradeTagId;
  // Please implement me
  sl_zigbee_af_core_println("Not supported.");
  return 1;
}
 ...
 */
WEAK(void sl_zigbee_af_ota_client_bootload_cb(const sl_zigbee_af_ota_image_id_t* id))
{
  (void)id;
 ...
 */
WEAK(sl_zigbee_af_image_verify_status_t sl_zigbee_af_ota_client_custom_verify_cb(bool newVerification,
                                                                                 const sl_zigbee_af_ota_image_id_t* id))
{
  (void)newVerification;
  (void)id;
 ...
 */
WEAK(bool sl_zigbee_af_ota_client_download_complete_cb(sl_zigbee_af_ota_download_result_t success,
                                                       const sl_zigbee_af_ota_image_id_t* id))
{
  (void)id;
 ...
 *
 */
WEAK(void sl_zigbee_af_ota_client_start_cb(void))
{
}
 ...
 */
WEAK(void sl_zigbee_af_ota_client_version_info_cb(sl_zigbee_af_ota_image_id_t* currentImageInfo,
 ...
 * hardwareVersion = SL_ZIGBEE_AF_INVALID_HARDWARE_VERSION;
   }
 ...
 *
 */
WEAK(int8u sl_zigbee_af_ota_page_request_server_policy_cb(void))
{
 ...
 * Ver.: always
 */
WEAK(int8u sl_zigbee_af_ota_server_block_size_cb(sl_802154_short_addr_t clientNodeId))
{
  ...
  // Data Size:   1-byte
  // Data:        variable
  const uint8_t IMAGE_BLOCK_RESPONSE_OVERHEAD = (SL_ZIGBEE_AF_ZCL_OVERHEAD + 14);
 ...
 */
WEAK(int8u sl_zigbee_af_ota_server_query_cb(const sl_zigbee_af_ota_image_id_t* currentImageId,
                                            int16u* hardwareVersion,
                                            sl_zigbee_af_ota_image_id_t* nextUpgradeImageId))
{
  (void)currentImageId;
  (void)hardwareVersion;
  (void)nextUpgradeImageId;
  // If a new software image is available, this function should return SL_ZIGBEE_ZCL_STATUS_SUCCESS
  ...
  // then the server should return SL_ZIGBEE_ZCL_STATUS_NO_IMAGE_AVAILABLE.
  return SL_ZIGBEE_ZCL_STATUS_NO_IMAGE_AVAILABLE;
}
 ...
 */
WEAK(bool sl_zigbee_af_ota_server_send_image_notify_cb(sl_802154_short_addr_t dest,
                                                       int8u endpoint,
                                                       int8u payloadType,
                                                       int8u queryJitter,
                                                       const sl_zigbee_af_ota_image_id_t* id))
                                                         ...
                                                         const sl_zigbee_af_ota_image_id_t* imageId))
{
  ...
  (void)status;
  (void)imageId;
  // If the status value is not SL_ZIGBEE_ZCL_STATUS_SUCCESS, then this callback is
 ...
 */
WEAK(sl_zigbee_af_ota_storage_status_t sl_zigbee_af_ota_storage_check_temp_data_cb(int32u* currentOffset,
 ...
 *
 */
WEAK(sl_zigbee_af_ota_storage_status_t sl_zigbee_af_ota_storage_clear_temp_data_cb(void))
{
 ...
 *
 */
WEAK(void sl_zigbee_af_ota_storage_close_cb(void))
{
  // Please implement me.
  assert(false);
}
 ...
 * always
 */
WEAK(void sl_zigbee_af_ota_storage_driver_download_finish_cb(int32u offset))
{
  (void)offset;
 ...
 *
 */
WEAK(bool sl_zigbee_af_ota_storage_driver_init_cb(void))
{
  // The storage driver and the rest of the OTA bootload code will not function correctly unless it is implemnted.
  // Please implement me.
  assert(false);
 ...
 *
 */
WEAK(sl_zigbee_af_ota_storage_status_t sl_zigbee_af_ota_storage_driver_invalidate_image_cb(void))
{
  // The storage driver and the rest of the OTA bootload code will not function correctly unless it is implemnted.
  // Please implement me.
  assert(false);
 ...
 *
 */
WEAK(sl_zigbee_af_ota_storage_status_t sl_zigbee_af_ota_storage_driver_prepare_to_resume_download_cb(void))
{
  assert(false);
  return SL_ZIGBEE_AF_OTA_STORAGE_ERROR;
}
 ...
 */
WEAK(bool sl_zigbee_af_ota_storage_driver_read_cb(int32u offset,
                                                  int32u length,
                                                  int8u* returnData))
{
  (void)offset;
 ...
 *
 */
WEAK(int32u sl_zigbee_af_ota_storage_driver_retrieve_last_stored_offset_cb(void))
{
  // The storage driver and the rest of the OTA bootload code will not function correctly unless it is implemnted.
  // Please implement me.
  assert(false);
 ...
 * Ver.: always
 */
WEAK(bool sl_zigbee_af_ota_storage_driver_write_cb(const int8u* dataToWrite,
                                                   int32u offset,
                                                   int32u length))
{
  (void)dataToWrite;
 ...
 * Ver.: always
 */
WEAK(sl_zigbee_af_ota_storage_status_t sl_zigbee_af_ota_storage_finish_download_cb(int32u offset))
{
  (void)offset;
 ...
 *
 */
WEAK(int8u sl_zigbee_af_ota_storage_get_count_cb(void))
{
  return 0;
}
 ...
 */
WEAK(int32u sl_zigbee_af_ota_storage_get_total_image_size_cb(const sl_zigbee_af_ota_image_id_t* id))
{
  (void)id;
 ...
 *
 */
WEAK(sl_zigbee_af_ota_storage_status_t sl_zigbee_af_ota_storage_init_cb(void))
{
  return SL_ZIGBEE_AF_OTA_STORAGE_SUCCESS;
}
 ...
 *
 */
WEAK(sl_zigbee_af_ota_image_id_t sl_zigbee_af_ota_storage_iterator_first_cb(void))
{
 ...
 *
 */
WEAK(sl_zigbee_af_ota_image_id_t sl_zigbee_af_ota_storage_iterator_next_cb(void))
{
  // It is expected that the storage module maintain its own internal iterator that the 'first' and 'next' functions will manipulate.
 ...
 */
WEAK(sl_zigbee_af_ota_storage_status_t sl_zigbee_af_ota_storage_write_temp_data_cb(int32u offset,
                                                                                   int32u length,
                                                                                   const int8u* data))
{
  (void)offset;
 ...
 * @param data auxiliary data included with the packet  Ver.: always
 ...
 */
WEAK(sl_zigbee_zdo_status_t sl_zigbee_af_partner_link_key_exchange_request_cb(sl_802154_long_addr_t partner))
{
  (void)partner;
  return SL_ZIGBEE_ZDP_NOT_SUPPORTED;
}
 ...
 */
WEAK(void sl_zigbee_af_partner_link_key_exchange_response_cb(sl_802154_short_addr_t sender,
 ...
 *
 */
WEAK(bool sl_zigbee_af_performing_key_establishment_cb(void))
{
  return false;
}
 ...
 * @param value   Ver.: always
 */
WEAK(void sl_zigbee_af_post_attribute_change_cb(int8u endpoint,
                                                sl_zigbee_af_cluster_id_t clusterId,
                                                sl_zigbee_af_attribute_id_t attributeId,
                                                int8u mask,
                                                int16u manufacturerCode,
 ...
 *
 */
WEAK(void sl_zigbee_af_post_em4_reset_cb(void))
{
  return;
}
 ...
 * @param value   Ver.: always
 */
WEAK(sl_zigbee_af_status_t sl_zigbee_af_pre_attribute_change_cb(int8u endpoint,
                                                                sl_zigbee_af_cluster_id_t clusterId,
                                                                sl_zigbee_af_attribute_id_t attributeId,
                                                                int8u mask,
                                                                int16u manufacturerCode,
 ...
 */
WEAK(bool sl_zigbee_af_pre_cli_send_cb(sl_zigbee_aps_frame_t* apsFrame,
 ...
 * @param cmd   Ver.: always
 */
WEAK(bool sl_zigbee_af_pre_command_received_cb(sl_zigbee_af_cluster_command_t* cmd))
{
  (void)cmd;
  return false;
}
 ...
 */
WEAK(bool sl_zigbee_af_pre_message_received_cb(sl_zigbee_af_incoming_message_t* incomingMessage))
{
 ...
 * caller.  Ver.: always
 */
WEAK(bool sl_zigbee_af_pre_message_send_cb(sl_zigbee_af_message_struct_t* messageStruct,
                                           sl_status_t* status))
{
  (void)messageStruct;
  (void)status;
 ...
 *
 */
WEAK(void sl_zigbee_af_pre_ncp_reset_cb(void))
{
}
 ...
 */
WEAK(bool sl_zigbee_af_pre_zdo_message_received_cb(sl_802154_short_addr_t sl_zigbee_node_id,
                                                   sl_zigbee_aps_frame_t* apsFrame,
                                                   int8u* message,
                                                   int16u length))
{
  (void)sl_zigbee_node_id;
  (void)apsFrame;
  (void)message;
  (void)length;
  return false;
 ...
 * @param bufLen The length in bytes of the list.  Ver.: always
 */
WEAK(bool sl_zigbee_af_read_attributes_response_cb(sl_zigbee_af_cluster_id_t clusterId,
                                                   int8u *buffer,
                                                   int16u bufLen))
{
  (void)clusterId;
 ...
 * @param cmd   Ver.: always
 */
WEAK(bool sl_zigbee_af_read_reporting_configuration_command_cb(const sl_zigbee_af_cluster_command_t *cmd))
{
  (void)cmd;
  return false;
}
 ...
 * @param bufLen The length in bytes of the list.  Ver.: always
 */
WEAK(bool sl_zigbee_af_read_reporting_configuration_response_cb(sl_zigbee_af_cluster_id_t clusterId,
                                                                int8u *buffer,
                                                                int16u bufLen))
{
  (void)clusterId;
 ...
 *
 */
WEAK(void sl_zigbee_af_registration_abort_cb(void))
{
}
 ...
 */
WEAK(void sl_zigbee_af_registration_cb(bool success))
{
  (void)success;
}
 ...
 *
 */
WEAK(sl_status_t sl_zigbee_af_registration_start_cb(void))
{
  return SL_STATUS_NOT_AVAILABLE;
}
 ...
 */
WEAK(sl_status_t sl_zigbee_af_remote_delete_binding_permission_cb(int8u index))
{
  (void)index;
  return SL_STATUS_OK; // default
}
 ...
 */
WEAK(sl_status_t sl_zigbee_af_remote_set_binding_permission_cb(const sl_zigbee_binding_table_entry_t *entry))
{
  (void)entry;
  return SL_STATUS_OK; // default
}
 ...
 * @param tasks   Ver.: always
 */
WEAK(void sl_zigbee_af_remove_from_current_app_tasks_cb(sl_zigbee_af_application_task_t tasks))
{
  (void)tasks;
}
 ...
 * @param bufLen The length in bytes of the list.  Ver.: always
 */
WEAK(bool sl_zigbee_af_report_attributes_cb(sl_zigbee_af_cluster_id_t clusterId,
                                            int8u *buffer,
                                            int16u bufLen))
{
  (void)clusterId;
 ...
 */
WEAK(void sl_zigbee_af_reporting_attribute_change_cb(int8u endpoint,
                                                     sl_zigbee_af_cluster_id_t clusterId,
                                                     sl_zigbee_af_attribute_id_t attributeId,
                                                     int8u mask,
                                                     int16u manufacturerCode,
 ...
 */
WEAK(void sl_zigbee_af_security_init_cb(sl_zigbee_initial_security_state_t *state,
 ...
 */
WEAK(void sl_zigbee_af_set_default_poll_control_cb(sl_zigbee_af_event_poll_control_t control))
{
  (void)control;
}
 ...
 * @param control   Ver.: always
 */
WEAK(void sl_zigbee_af_set_default_sleep_control_cb(sl_zigbee_af_event_sleep_control_t control))
{
  (void)control;
}
 ...
 */
WEAK(void sl_zigbee_af_set_form_and_join_extended_pan_id_cb(const int8u *extendedPanId))
{
  (void)extendedPanId;
}
 ...
 */
WEAK(void sl_zigbee_af_set_long_poll_interval_ms_cb(int32u longPollIntervalMs))
{
  (void)longPollIntervalMs;
}
 ...
 */
WEAK(void sl_zigbee_af_set_long_poll_interval_qs_cb(int32u longPollIntervalQs))
{
 ...
 */
WEAK(void sl_zigbee_af_set_short_poll_interval_ms_cb(int16u shortPollIntervalMs))
{
  (void)shortPollIntervalMs;
}
 ...
 */
WEAK(void sl_zigbee_af_set_short_poll_interval_qs_cb(int16u shortPollIntervalQs))
{
 ...
 */
WEAK(void sl_zigbee_af_set_source_route_overhead_cb(sl_802154_short_addr_t destination,
                                                    int8u overhead))
{
  (void)destination;
  (void)overhead;
 ...
 */
WEAK(void sl_zigbee_af_set_time_cb(int32u utcTime))
{
  (void)utcTime;
}
 ...
 * @param tasks   Ver.: always
 */
WEAK(void sl_zigbee_af_set_wake_timeout_bitmask_cb(sl_zigbee_af_application_task_t tasks))
{
  (void)tasks;
}
 ...
 */
WEAK(void sl_zigbee_af_set_wake_timeout_ms_cb(int16u wakeTimeoutMs))
{
  (void)wakeTimeoutMs;
}
 ...
 */
WEAK(void sl_zigbee_af_set_wake_timeout_qs_cb(int16u wakeTimeoutQs))
{
  (void)wakeTimeoutQs;
}
 ...
 *
 */
WEAK(bool sl_zigbee_af_start_move_cb(void))
{
  return false;
}
 ...
 *
 */
WEAK(sl_status_t sl_zigbee_af_start_search_for_joinable_network_cb(void))
{
  return SL_STATUS_NOT_AVAILABLE;
}
 ...
 *
 */
WEAK(void sl_zigbee_af_stop_move_cb(void))
{
}
 ...
 */
WEAK(void sl_zigbee_af_trust_center_join_cb(sl_802154_short_addr_t newNodeId,
 ...
 *
 */
WEAK(void sl_zigbee_af_trust_center_keepalive_abort_cb(void))
{
}
 ...
 */
WEAK(void sl_zigbee_af_trust_center_keepalive_update_cb(bool registrationComplete))
{
 ...
 * @param bufLen The length in bytes of the list.  Ver.: always
 */
WEAK(bool sl_zigbee_af_write_attributes_response_cb(sl_zigbee_af_cluster_id_t clusterId,
                                                    int8u *buffer,
                                                    int16u bufLen))
{
  (void)clusterId;
