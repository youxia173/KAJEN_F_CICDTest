 ...
 */
WEAK(void sl_zigbee_af_groups_cluster_clear_group_table_cb(int8u endpoint))
{
  (void)endpoint;
}
 ...
 */
WEAK(bool sl_zigbee_af_groups_cluster_endpoint_in_group_cb(int8u endpoint,
                                                           int16u groupId))
{
  (void)endpoint;
  (void)groupId;
 ...
 * @param endpoint The endpoint.  Ver.: always
 */
WEAK(void sl_zigbee_af_scenes_cluster_clear_scene_table_cb(int8u endpoint))
{
  (void)endpoint;
}
 ...
 */
WEAK(sl_zigbee_af_status_t sl_zigbee_af_scenes_cluster_make_invalid_cb(int8u endpoint))
{
  (void)endpoint;
 ...
 */
WEAK(sl_zigbee_af_status_t sl_zigbee_af_scenes_cluster_recall_saved_scene_cb(int8u endpoint,
                                                                             int16u groupId,
                                                                             int8u sceneId))
{
  (void)endpoint;
 ...
 */
WEAK(void sl_zigbee_af_scenes_cluster_remove_scenes_in_group_cb(int8u endpoint,
                                                                int16u groupId))
{
  (void)endpoint;
  (void)groupId;
 ...
 * @param sceneId The scene identifier.  Ver.: always
 */
WEAK(sl_zigbee_af_status_t sl_zigbee_af_scenes_cluster_store_current_scene_cb(int8u endpoint,
                                                                              int16u groupId,
                                                                              int8u sceneId))
{
  (void)endpoint;
 ...
 */
WEAK(void sl_zigbee_af_on_off_cluster_level_control_effect_cb(int8u endpoint,
                                                              bool newValue))
{
  (void)endpoint;
  (void)newValue;
 ...
 */
WEAK(sl_zigbee_af_status_t sl_zigbee_af_on_off_cluster_set_value_cb(int8u endpoint,
                                                                    int8u command,
                                                                    bool initiatedByLevelChange))
{
  (void)endpoint;
  (void)command;
  (void)initiatedByLevelChange;
  return SL_ZIGBEE_ZCL_STATUS_UNSUP_COMMAND;
}
 ...
 */
WEAK(bool sl_zigbee_af_key_establishment_cluster_client_command_received_cb(sl_zigbee_af_cluster_command_t *cmd))
{
  (void)cmd;
  return false;
}
 ...
 * @param cmd   Ver.: always
 */
WEAK(bool sl_zigbee_af_key_establishment_cluster_server_command_received_cb(sl_zigbee_af_cluster_command_t *cmd))
{
  (void)cmd;
  return false;
}
