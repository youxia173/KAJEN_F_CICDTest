...
#if defined(MBEDTLS_ECP_SHORT_WEIERSTRASS_ENABLED) \
    && defined(MBEDTLS_ECP_ENABLE_COMPRESSED_CURVE_PARSING)
...
#if defined(MBEDTLS_ECP_ENABLE_COMPRESSED_CURVE_PARSING)
...
#endif /* !(MBEDTLS_ECP_NO_FALLBACK && MBEDTLS_ECP_DOUBLE_JAC_ALT) */
...
#endif /* MBEDTLS_ECP_ENABLE_COMPRESSED_CURVE_PARSING */
