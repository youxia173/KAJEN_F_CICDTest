/**************************************************************************//**
 * @file
 * @brief SIMG301 GPIO register and bit field definitions
 ******************************************************************************
 * # License
 ...
 *
 *****************************************************************************/
#ifndef SIMG301_GPIO_H
#define SIMG301_GPIO_H
...
typedef struct gpio_cmuroute_typedef{
  __IOM uint32_t ROUTEEN;                            /**< HOSTCMU pin enable                                 */
...
typedef struct gpio_letimerroute_typedef{
  __IOM uint32_t ROUTEEN;                            /**< LETIMER0 pin enable                                */
  __IOM uint32_t OUT0ROUTE;                          /**< OUT0 port/pin select                               */
  __IOM uint32_t OUT1ROUTE;                          /**< OUT1 port/pin select                               */
  uint32_t       RESERVED0[1U];                      /**< Reserved for future use                            */
} GPIO_LETIMERROUTE_TypeDef;

typedef struct gpio_lfxoroute_typedef{
  __IOM uint32_t ROUTEEN;                            /**< LFXO pin enable                                    */
  __IOM uint32_t LFXOCLKLVRAWROUTE;                  /**< LFXOCLKLVRAW port/pin select                       */
  uint32_t       RESERVED0[1U];                      /**< Reserved for future use                            */
} GPIO_LFXOROUTE_TypeDef;
...
typedef struct gpio_pixelrzroute_typedef{
  __IOM uint32_t ROUTEEN;                            /**< PIXELRZ0 pin enable                                */
  __IOM uint32_t RZTXOUTROUTE;                       /**< RZTXOUT port/pin select                            */
  uint32_t       RESERVED0[1U];                      /**< Reserved for future use                            */
} GPIO_PIXELRZROUTE_TypeDef;
...
typedef struct gpio_timer0route_typedef{
  ...
  uint32_t       RESERVED0[1U];                      /**< Reserved for future use                            */
} GPIO_TIMER0ROUTE_TypeDef;

typedef struct gpio_timer1route_typedef{
  __IOM uint32_t ROUTEEN;                            /**< TIMER1 pin enable                                  */
  __IOM uint32_t CC0ROUTE;                           /**< CC0 port/pin select                                */
  __IOM uint32_t CC1ROUTE;                           /**< CC1 port/pin select                                */
  __IOM uint32_t CC2ROUTE;                           /**< CC2 port/pin select                                */
  __IOM uint32_t CDTI0ROUTE;                         /**< CDTI0 port/pin select                              */
  ...
  __IOM uint32_t CDTI2ROUTE;                         /**< CDTI2 port/pin select                              */
  uint32_t       RESERVED0[1U];                      /**< Reserved for future use                            */
} GPIO_TIMER1ROUTE_TypeDef;

typedef struct gpio_timer2route_typedef{
  __IOM uint32_t ROUTEEN;                            /**< TIMER2 pin enable                                  */
  __IOM uint32_t CC0ROUTE;                           /**< CC0 port/pin select                                */
  __IOM uint32_t CC1ROUTE;                           /**< CC1 port/pin select                                */
  __IOM uint32_t CC2ROUTE;                           /**< CC2 port/pin select                                */
  __IOM uint32_t CC3ROUTE;                           /**< CC3 port/pin select                                */
  __IOM uint32_t CC4ROUTE;                           /**< CC4 port/pin select                                */
  __IOM uint32_t CC5ROUTE;                           /**< CC5 port/pin select                                */
  __IOM uint32_t CC6ROUTE;                           /**< CC6 port/pin select                                */
  __IOM uint32_t CDTI0ROUTE;                         /**< CDTI0 port/pin select                              */
  __IOM uint32_t CDTI1ROUTE;                         /**< CDTI1 port/pin select                              */
  __IOM uint32_t CDTI2ROUTE;                         /**< CDTI2 port/pin select                              */
  __IOM uint32_t CDTI3ROUTE;                         /**< CDTI3 port/pin select                              */
  __IOM uint32_t CDTI4ROUTE;                         /**< CDTI4 port/pin select                              */
  __IOM uint32_t CDTI5ROUTE;                         /**< CDTI5 port/pin select                              */
  __IOM uint32_t CDTI6ROUTE;                         /**< CDTI6 port/pin select                              */
  uint32_t       RESERVED0[1U];                      /**< Reserved for future use                            */
} GPIO_TIMER2ROUTE_TypeDef;

typedef struct gpio_timer3route_typedef{
  __IOM uint32_t ROUTEEN;                            /**< TIMER3 pin enable                                  */
  __IOM uint32_t CC0ROUTE;                           /**< CC0 port/pin select                                */
  __IOM uint32_t CC1ROUTE;                           /**< CC1 port/pin select                                */
  __IOM uint32_t CC2ROUTE;                           /**< CC2 port/pin select                                */
  __IOM uint32_t CC3ROUTE;                           /**< CC3 port/pin select                                */
...
typedef struct gpio_typedef{
  ...
  GPIO_I2CROUTE_TypeDef     I2CROUTE[3U];            /**< i2c0 DBUS config registers                         */
  GPIO_LETIMERROUTE_TypeDef LETIMERROUTE[1U];        /**< letimer0 DBUS config registers                     */
  GPIO_LFXOROUTE_TypeDef    LFXOROUTE;               /**< lfxo DBUS config registers                         */
  ...
  GPIO_PIXELRZROUTE_TypeDef PIXELRZROUTE[2U];        /**< pixelrz0 DBUS config registers                     */
  ...
  GPIO_TIMER0ROUTE_TypeDef  TIMER0ROUTE[1U];         /**< timer0 DBUS config registers                       */
  GPIO_TIMER1ROUTE_TypeDef  TIMER1ROUTE[1U];         /**< timer1 DBUS config registers                       */
  GPIO_TIMER2ROUTE_TypeDef  TIMER2ROUTE[1U];         /**< timer2 DBUS config registers                       */
  GPIO_TIMER3ROUTE_TypeDef  TIMER3ROUTE[1U];         /**< timer3 DBUS config registers                       */
  uint32_t                  RESERVED10[566U];        /**< Reserved for future use                            */
  ...
  GPIO_I2CROUTE_TypeDef     I2CROUTE_SET[3U];        /**< i2c0 DBUS config registers                         */
  GPIO_LETIMERROUTE_TypeDef LETIMERROUTE_SET[1U];    /**< letimer0 DBUS config registers                     */
  GPIO_LFXOROUTE_TypeDef    LFXOROUTE_SET;           /**< lfxo DBUS config registers                         */
  ...
  GPIO_PIXELRZROUTE_TypeDef PIXELRZROUTE_SET[2U];    /**< pixelrz0 DBUS config registers                     */
  ...
  GPIO_TIMER0ROUTE_TypeDef  TIMER0ROUTE_SET[1U];     /**< timer0 DBUS config registers                       */
  GPIO_TIMER1ROUTE_TypeDef  TIMER1ROUTE_SET[1U];     /**< timer1 DBUS config registers                       */
  GPIO_TIMER2ROUTE_TypeDef  TIMER2ROUTE_SET[1U];     /**< timer2 DBUS config registers                       */
  GPIO_TIMER3ROUTE_TypeDef  TIMER3ROUTE_SET[1U];     /**< timer3 DBUS config registers                       */
  uint32_t                  RESERVED21[566U];        /**< Reserved for future use                            */
  ...
  GPIO_I2CROUTE_TypeDef     I2CROUTE_CLR[3U];        /**< i2c0 DBUS config registers                         */
  GPIO_LETIMERROUTE_TypeDef LETIMERROUTE_CLR[1U];    /**< letimer0 DBUS config registers                     */
  GPIO_LFXOROUTE_TypeDef    LFXOROUTE_CLR;           /**< lfxo DBUS config registers                         */
  ...
  GPIO_PIXELRZROUTE_TypeDef PIXELRZROUTE_CLR[2U];    /**< pixelrz0 DBUS config registers                     */
  ...
  uint32_t                  RESERVED31[23U];         /**< Reserved for future use                            */
  GPIO_TIMER0ROUTE_TypeDef  TIMER0ROUTE_CLR[1U];     /**< timer0 DBUS config registers                       */
  GPIO_TIMER1ROUTE_TypeDef  TIMER1ROUTE_CLR[1U];     /**< timer1 DBUS config registers                       */
  GPIO_TIMER2ROUTE_TypeDef  TIMER2ROUTE_CLR[1U];     /**< timer2 DBUS config registers                       */
  GPIO_TIMER3ROUTE_TypeDef  TIMER3ROUTE_CLR[1U];     /**< timer3 DBUS config registers                       */
  uint32_t                  RESERVED32[566U];        /**< Reserved for future use                            */
  ...
  GPIO_I2CROUTE_TypeDef     I2CROUTE_TGL[3U];        /**< i2c0 DBUS config registers                         */
  GPIO_LETIMERROUTE_TypeDef LETIMERROUTE_TGL[1U];    /**< letimer0 DBUS config registers                     */
  GPIO_LFXOROUTE_TypeDef    LFXOROUTE_TGL;           /**< lfxo DBUS config registers                         */
  ...
  GPIO_PIXELRZROUTE_TypeDef PIXELRZROUTE_TGL[2U];    /**< pixelrz0 DBUS config registers                     */
  ...
  uint32_t                  RESERVED42[23U];         /**< Reserved for future use                            */
  GPIO_TIMER0ROUTE_TypeDef  TIMER0ROUTE_TGL[1U];     /**< timer0 DBUS config registers                       */
  GPIO_TIMER1ROUTE_TypeDef  TIMER1ROUTE_TGL[1U];     /**< timer1 DBUS config registers                       */
  GPIO_TIMER2ROUTE_TypeDef  TIMER2ROUTE_TGL[1U];     /**< timer2 DBUS config registers                       */
  GPIO_TIMER3ROUTE_TypeDef  TIMER3ROUTE_TGL[1U];     /**< timer3 DBUS config registers                       */
} GPIO_TypeDef;

#define GPIO_PORT_INDEX                               0x0000000FUL

/* Bit fields for GPIO IPVERSION */
#define _GPIO_IPVERSION_RESETVALUE                    0x00000008UL                             /**< Default value for GPIO_IPVERSION            */
...
#define _GPIO_IPVERSION_IPVERSION_DEFAULT             0x00000008UL                             /**< Mode DEFAULT for GPIO_IPVERSION             */
...
#define _GPIO_BBUSALLOC_BEVEN0_DIAGA                  0x0000000EUL                           /**< Mode DIAGA for GPIO_BBUSALLOC               */
...
#define GPIO_BBUSALLOC_BEVEN0_DIAGA                   (_GPIO_BBUSALLOC_BEVEN0_DIAGA << 0)    /**< Shifted mode DIAGA for GPIO_BBUSALLOC       */
...
#define _GPIO_CDBUSALLOC_CDEVEN0_LEDDRV               0x00000004UL                             /**< Mode LEDDRV for GPIO_CDBUSALLOC             */
...
#define GPIO_CDBUSALLOC_CDEVEN0_LEDDRV                (_GPIO_CDBUSALLOC_CDEVEN0_LEDDRV << 0)   /**< Shifted mode LEDDRV for GPIO_CDBUSALLOC     */
...
#define _GPIO_CDBUSALLOC_CDEVEN1_LEDDRV               0x00000004UL                             /**< Mode LEDDRV for GPIO_CDBUSALLOC             */
...
#define GPIO_CDBUSALLOC_CDEVEN1_LEDDRV                (_GPIO_CDBUSALLOC_CDEVEN1_LEDDRV << 8)   /**< Shifted mode LEDDRV for GPIO_CDBUSALLOC     */
...
#define _GPIO_CDBUSALLOC_CDODD0_LEDDRV                0x00000004UL                             /**< Mode LEDDRV for GPIO_CDBUSALLOC             */
...
#define GPIO_CDBUSALLOC_CDODD0_LEDDRV                 (_GPIO_CDBUSALLOC_CDODD0_LEDDRV << 16)   /**< Shifted mode LEDDRV for GPIO_CDBUSALLOC     */
...
#define _GPIO_CDBUSALLOC_CDODD1_LEDDRV                0x00000004UL                             /**< Mode LEDDRV for GPIO_CDBUSALLOC             */
...
#define GPIO_CDBUSALLOC_CDODD1_LEDDRV                 (_GPIO_CDBUSALLOC_CDODD1_LEDDRV << 24)   /**< Shifted mode LEDDRV for GPIO_CDBUSALLOC     */
...
/* Bit fields for GPIO_LFXO ROUTEEN */
#define _GPIO_LFXO_ROUTEEN_RESETVALUE                 0x00000000UL                                      /**< Default value for GPIO_LFXO_ROUTEEN         */
#define _GPIO_LFXO_ROUTEEN_MASK                       0x00000001UL                                      /**< Mask for GPIO_LFXO_ROUTEEN                  */
#define GPIO_LFXO_ROUTEEN_LFXOCLKLVRAWPEN             (0x1UL << 0)                                      /**< LFXOCLKLVRAW pin enable control bit         */
#define _GPIO_LFXO_ROUTEEN_LFXOCLKLVRAWPEN_SHIFT      0                                                 /**< Shift value for GPIO_LFXOCLKLVRAWPEN        */
#define _GPIO_LFXO_ROUTEEN_LFXOCLKLVRAWPEN_MASK       0x1UL                                             /**< Bit mask for GPIO_LFXOCLKLVRAWPEN           */
#define _GPIO_LFXO_ROUTEEN_LFXOCLKLVRAWPEN_DEFAULT    0x00000000UL                                      /**< Mode DEFAULT for GPIO_LFXO_ROUTEEN          */
#define GPIO_LFXO_ROUTEEN_LFXOCLKLVRAWPEN_DEFAULT     (_GPIO_LFXO_ROUTEEN_LFXOCLKLVRAWPEN_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_LFXO_ROUTEEN  */

/* Bit fields for GPIO_LFXO LFXOCLKLVRAWROUTE */
#define _GPIO_LFXO_LFXOCLKLVRAWROUTE_RESETVALUE       0x00000000UL                                     /**< Default value for GPIO_LFXO_LFXOCLKLVRAWROUTE*/
#define _GPIO_LFXO_LFXOCLKLVRAWROUTE_MASK             0x000F0003UL                                     /**< Mask for GPIO_LFXO_LFXOCLKLVRAWROUTE        */
#define _GPIO_LFXO_LFXOCLKLVRAWROUTE_PORT_SHIFT       0                                                /**< Shift value for GPIO_PORT                   */
#define _GPIO_LFXO_LFXOCLKLVRAWROUTE_PORT_MASK        0x3UL                                            /**< Bit mask for GPIO_PORT                      */
#define _GPIO_LFXO_LFXOCLKLVRAWROUTE_PORT_DEFAULT     0x00000000UL                                     /**< Mode DEFAULT for GPIO_LFXO_LFXOCLKLVRAWROUTE*/
#define GPIO_LFXO_LFXOCLKLVRAWROUTE_PORT_DEFAULT      (_GPIO_LFXO_LFXOCLKLVRAWROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_LFXO_LFXOCLKLVRAWROUTE*/
#define _GPIO_LFXO_LFXOCLKLVRAWROUTE_PIN_SHIFT        16                                               /**< Shift value for GPIO_PIN                    */
#define _GPIO_LFXO_LFXOCLKLVRAWROUTE_PIN_MASK         0xF0000UL                                        /**< Bit mask for GPIO_PIN                       */
#define _GPIO_LFXO_LFXOCLKLVRAWROUTE_PIN_DEFAULT      0x00000000UL                                     /**< Mode DEFAULT for GPIO_LFXO_LFXOCLKLVRAWROUTE*/
#define GPIO_LFXO_LFXOCLKLVRAWROUTE_PIN_DEFAULT       (_GPIO_LFXO_LFXOCLKLVRAWROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_LFXO_LFXOCLKLVRAWROUTE*/
...
/* Bit fields for GPIO_PIXELRZ ROUTEEN */
#define _GPIO_PIXELRZ_ROUTEEN_RESETVALUE              0x00000000UL                                    /**< Default value for GPIO_PIXELRZ_ROUTEEN      */
#define _GPIO_PIXELRZ_ROUTEEN_MASK                    0x00000001UL                                    /**< Mask for GPIO_PIXELRZ_ROUTEEN               */
#define GPIO_PIXELRZ_ROUTEEN_RZTXOUTPEN               (0x1UL << 0)                                    /**< RZTXOUT pin enable control bit              */
#define _GPIO_PIXELRZ_ROUTEEN_RZTXOUTPEN_SHIFT        0                                               /**< Shift value for GPIO_RZTXOUTPEN             */
#define _GPIO_PIXELRZ_ROUTEEN_RZTXOUTPEN_MASK         0x1UL                                           /**< Bit mask for GPIO_RZTXOUTPEN                */
#define _GPIO_PIXELRZ_ROUTEEN_RZTXOUTPEN_DEFAULT      0x00000000UL                                    /**< Mode DEFAULT for GPIO_PIXELRZ_ROUTEEN       */
#define GPIO_PIXELRZ_ROUTEEN_RZTXOUTPEN_DEFAULT       (_GPIO_PIXELRZ_ROUTEEN_RZTXOUTPEN_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_PIXELRZ_ROUTEEN*/

/* Bit fields for GPIO_PIXELRZ RZTXOUTROUTE */
#define _GPIO_PIXELRZ_RZTXOUTROUTE_RESETVALUE         0x00000000UL                                   /**< Default value for GPIO_PIXELRZ_RZTXOUTROUTE */
#define _GPIO_PIXELRZ_RZTXOUTROUTE_MASK               0x000F0003UL                                   /**< Mask for GPIO_PIXELRZ_RZTXOUTROUTE          */
#define _GPIO_PIXELRZ_RZTXOUTROUTE_PORT_SHIFT         0                                              /**< Shift value for GPIO_PORT                   */
#define _GPIO_PIXELRZ_RZTXOUTROUTE_PORT_MASK          0x3UL                                          /**< Bit mask for GPIO_PORT                      */
#define _GPIO_PIXELRZ_RZTXOUTROUTE_PORT_DEFAULT       0x00000000UL                                   /**< Mode DEFAULT for GPIO_PIXELRZ_RZTXOUTROUTE  */
#define GPIO_PIXELRZ_RZTXOUTROUTE_PORT_DEFAULT        (_GPIO_PIXELRZ_RZTXOUTROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_PIXELRZ_RZTXOUTROUTE*/
#define _GPIO_PIXELRZ_RZTXOUTROUTE_PIN_SHIFT          16                                             /**< Shift value for GPIO_PIN                    */
#define _GPIO_PIXELRZ_RZTXOUTROUTE_PIN_MASK           0xF0000UL                                      /**< Bit mask for GPIO_PIN                       */
#define _GPIO_PIXELRZ_RZTXOUTROUTE_PIN_DEFAULT        0x00000000UL                                   /**< Mode DEFAULT for GPIO_PIXELRZ_RZTXOUTROUTE  */
#define GPIO_PIXELRZ_RZTXOUTROUTE_PIN_DEFAULT         (_GPIO_PIXELRZ_RZTXOUTROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_PIXELRZ_RZTXOUTROUTE*/
...
/* Bit fields for GPIO_RAC ROUTEEN */
#define _GPIO_RAC_ROUTEEN_RESETVALUE                  0x00000000UL                              /**< Default value for GPIO_RAC_ROUTEEN          */
#define _GPIO_RAC_ROUTEEN_MASK                        0x00000003UL                              /**< Mask for GPIO_RAC_ROUTEEN                   */
#define GPIO_RAC_ROUTEEN_LNAENPEN                     (0x1UL << 0)                              /**< LNAEN pin enable control bit                */
#define _GPIO_RAC_ROUTEEN_LNAENPEN_SHIFT              0                                         /**< Shift value for GPIO_LNAENPEN               */
#define _GPIO_RAC_ROUTEEN_LNAENPEN_MASK               0x1UL                                     /**< Bit mask for GPIO_LNAENPEN                  */
#define _GPIO_RAC_ROUTEEN_LNAENPEN_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_RAC_ROUTEEN           */
#define GPIO_RAC_ROUTEEN_LNAENPEN_DEFAULT             (_GPIO_RAC_ROUTEEN_LNAENPEN_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_RAC_ROUTEEN   */
#define GPIO_RAC_ROUTEEN_PAENPEN                      (0x1UL << 1)                              /**< PAEN pin enable control bit                 */
#define _GPIO_RAC_ROUTEEN_PAENPEN_SHIFT               1                                         /**< Shift value for GPIO_PAENPEN                */
#define _GPIO_RAC_ROUTEEN_PAENPEN_MASK                0x2UL                                     /**< Bit mask for GPIO_PAENPEN                   */
#define _GPIO_RAC_ROUTEEN_PAENPEN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_RAC_ROUTEEN           */
#define GPIO_RAC_ROUTEEN_PAENPEN_DEFAULT              (_GPIO_RAC_ROUTEEN_PAENPEN_DEFAULT << 1)  /**< Shifted mode DEFAULT for GPIO_RAC_ROUTEEN   */

/* Bit fields for GPIO_RAC LNAENROUTE */
#define _GPIO_RAC_LNAENROUTE_RESETVALUE               0x00000000UL                             /**< Default value for GPIO_RAC_LNAENROUTE       */
#define _GPIO_RAC_LNAENROUTE_MASK                     0x000F0003UL                             /**< Mask for GPIO_RAC_LNAENROUTE                */
#define _GPIO_RAC_LNAENROUTE_PORT_SHIFT               0                                        /**< Shift value for GPIO_PORT                   */
#define _GPIO_RAC_LNAENROUTE_PORT_MASK                0x3UL                                    /**< Bit mask for GPIO_PORT                      */
#define _GPIO_RAC_LNAENROUTE_PORT_DEFAULT             0x00000000UL                             /**< Mode DEFAULT for GPIO_RAC_LNAENROUTE        */
#define GPIO_RAC_LNAENROUTE_PORT_DEFAULT              (_GPIO_RAC_LNAENROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_RAC_LNAENROUTE*/
#define _GPIO_RAC_LNAENROUTE_PIN_SHIFT                16                                       /**< Shift value for GPIO_PIN                    */
#define _GPIO_RAC_LNAENROUTE_PIN_MASK                 0xF0000UL                                /**< Bit mask for GPIO_PIN                       */
#define _GPIO_RAC_LNAENROUTE_PIN_DEFAULT              0x00000000UL                             /**< Mode DEFAULT for GPIO_RAC_LNAENROUTE        */
#define GPIO_RAC_LNAENROUTE_PIN_DEFAULT               (_GPIO_RAC_LNAENROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_RAC_LNAENROUTE*/

/* Bit fields for GPIO_RAC PAENROUTE */
#define _GPIO_RAC_PAENROUTE_RESETVALUE                0x00000000UL                            /**< Default value for GPIO_RAC_PAENROUTE        */
#define _GPIO_RAC_PAENROUTE_MASK                      0x000F0003UL                            /**< Mask for GPIO_RAC_PAENROUTE                 */
#define _GPIO_RAC_PAENROUTE_PORT_SHIFT                0                                       /**< Shift value for GPIO_PORT                   */
#define _GPIO_RAC_PAENROUTE_PORT_MASK                 0x3UL                                   /**< Bit mask for GPIO_PORT                      */
#define _GPIO_RAC_PAENROUTE_PORT_DEFAULT              0x00000000UL                            /**< Mode DEFAULT for GPIO_RAC_PAENROUTE         */
#define GPIO_RAC_PAENROUTE_PORT_DEFAULT               (_GPIO_RAC_PAENROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_RAC_PAENROUTE */
#define _GPIO_RAC_PAENROUTE_PIN_SHIFT                 16                                      /**< Shift value for GPIO_PIN                    */
#define _GPIO_RAC_PAENROUTE_PIN_MASK                  0xF0000UL                               /**< Bit mask for GPIO_PIN                       */
#define _GPIO_RAC_PAENROUTE_PIN_DEFAULT               0x00000000UL                            /**< Mode DEFAULT for GPIO_RAC_PAENROUTE         */
#define GPIO_RAC_PAENROUTE_PIN_DEFAULT                (_GPIO_RAC_PAENROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_RAC_PAENROUTE */

/* Bit fields for GPIO_TIMER0 ROUTEEN */
#define _GPIO_TIMER0_ROUTEEN_RESETVALUE               0x00000000UL                                /**< Default value for GPIO_TIMER0_ROUTEEN       */
#define _GPIO_TIMER0_ROUTEEN_MASK                     0x0000003FUL                                /**< Mask for GPIO_TIMER0_ROUTEEN                */
#define GPIO_TIMER0_ROUTEEN_CC0PEN                    (0x1UL << 0)                                /**< CC0 pin enable control bit                  */
#define _GPIO_TIMER0_ROUTEEN_CC0PEN_SHIFT             0                                           /**< Shift value for GPIO_CC0PEN                 */
#define _GPIO_TIMER0_ROUTEEN_CC0PEN_MASK              0x1UL                                       /**< Bit mask for GPIO_CC0PEN                    */
#define _GPIO_TIMER0_ROUTEEN_CC0PEN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER0_ROUTEEN        */
#define GPIO_TIMER0_ROUTEEN_CC0PEN_DEFAULT            (_GPIO_TIMER0_ROUTEEN_CC0PEN_DEFAULT << 0)  /**< Shifted mode DEFAULT for GPIO_TIMER0_ROUTEEN*/
#define GPIO_TIMER0_ROUTEEN_CC1PEN                    (0x1UL << 1)                                /**< CC1 pin enable control bit                  */
#define _GPIO_TIMER0_ROUTEEN_CC1PEN_SHIFT             1                                           /**< Shift value for GPIO_CC1PEN                 */
#define _GPIO_TIMER0_ROUTEEN_CC1PEN_MASK              0x2UL                                       /**< Bit mask for GPIO_CC1PEN                    */
#define _GPIO_TIMER0_ROUTEEN_CC1PEN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER0_ROUTEEN        */
#define GPIO_TIMER0_ROUTEEN_CC1PEN_DEFAULT            (_GPIO_TIMER0_ROUTEEN_CC1PEN_DEFAULT << 1)  /**< Shifted mode DEFAULT for GPIO_TIMER0_ROUTEEN*/
#define GPIO_TIMER0_ROUTEEN_CC2PEN                    (0x1UL << 2)                                /**< CC2 pin enable control bit                  */
#define _GPIO_TIMER0_ROUTEEN_CC2PEN_SHIFT             2                                           /**< Shift value for GPIO_CC2PEN                 */
#define _GPIO_TIMER0_ROUTEEN_CC2PEN_MASK              0x4UL                                       /**< Bit mask for GPIO_CC2PEN                    */
#define _GPIO_TIMER0_ROUTEEN_CC2PEN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER0_ROUTEEN        */
#define GPIO_TIMER0_ROUTEEN_CC2PEN_DEFAULT            (_GPIO_TIMER0_ROUTEEN_CC2PEN_DEFAULT << 2)  /**< Shifted mode DEFAULT for GPIO_TIMER0_ROUTEEN*/
#define GPIO_TIMER0_ROUTEEN_CCC0PEN                   (0x1UL << 3)                                /**< CDTI0 pin enable control bit                */
#define _GPIO_TIMER0_ROUTEEN_CCC0PEN_SHIFT            3                                           /**< Shift value for GPIO_CCC0PEN                */
#define _GPIO_TIMER0_ROUTEEN_CCC0PEN_MASK             0x8UL                                       /**< Bit mask for GPIO_CCC0PEN                   */
#define _GPIO_TIMER0_ROUTEEN_CCC0PEN_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER0_ROUTEEN        */
#define GPIO_TIMER0_ROUTEEN_CCC0PEN_DEFAULT           (_GPIO_TIMER0_ROUTEEN_CCC0PEN_DEFAULT << 3) /**< Shifted mode DEFAULT for GPIO_TIMER0_ROUTEEN*/
#define GPIO_TIMER0_ROUTEEN_CCC1PEN                   (0x1UL << 4)                                /**< CDTI1 pin enable control bit                */
#define _GPIO_TIMER0_ROUTEEN_CCC1PEN_SHIFT            4                                           /**< Shift value for GPIO_CCC1PEN                */
#define _GPIO_TIMER0_ROUTEEN_CCC1PEN_MASK             0x10UL                                      /**< Bit mask for GPIO_CCC1PEN                   */
#define _GPIO_TIMER0_ROUTEEN_CCC1PEN_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER0_ROUTEEN        */
#define GPIO_TIMER0_ROUTEEN_CCC1PEN_DEFAULT           (_GPIO_TIMER0_ROUTEEN_CCC1PEN_DEFAULT << 4) /**< Shifted mode DEFAULT for GPIO_TIMER0_ROUTEEN*/
#define GPIO_TIMER0_ROUTEEN_CCC2PEN                   (0x1UL << 5)                                /**< CDTI2 pin enable control bit                */
#define _GPIO_TIMER0_ROUTEEN_CCC2PEN_SHIFT            5                                           /**< Shift value for GPIO_CCC2PEN                */
#define _GPIO_TIMER0_ROUTEEN_CCC2PEN_MASK             0x20UL                                      /**< Bit mask for GPIO_CCC2PEN                   */
#define _GPIO_TIMER0_ROUTEEN_CCC2PEN_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER0_ROUTEEN        */
#define GPIO_TIMER0_ROUTEEN_CCC2PEN_DEFAULT           (_GPIO_TIMER0_ROUTEEN_CCC2PEN_DEFAULT << 5) /**< Shifted mode DEFAULT for GPIO_TIMER0_ROUTEEN*/

/* Bit fields for GPIO_TIMER0 CC0ROUTE */
#define _GPIO_TIMER0_CC0ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER0_CC0ROUTE      */
#define _GPIO_TIMER0_CC0ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER0_CC0ROUTE               */
#define _GPIO_TIMER0_CC0ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER0_CC0ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER0_CC0ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER0_CC0ROUTE       */
#define GPIO_TIMER0_CC0ROUTE_PORT_DEFAULT             (_GPIO_TIMER0_CC0ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER0_CC0ROUTE*/
#define _GPIO_TIMER0_CC0ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER0_CC0ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER0_CC0ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER0_CC0ROUTE       */
#define GPIO_TIMER0_CC0ROUTE_PIN_DEFAULT              (_GPIO_TIMER0_CC0ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER0_CC0ROUTE*/

/* Bit fields for GPIO_TIMER0 CC1ROUTE */
#define _GPIO_TIMER0_CC1ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER0_CC1ROUTE      */
#define _GPIO_TIMER0_CC1ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER0_CC1ROUTE               */
#define _GPIO_TIMER0_CC1ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER0_CC1ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER0_CC1ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER0_CC1ROUTE       */
#define GPIO_TIMER0_CC1ROUTE_PORT_DEFAULT             (_GPIO_TIMER0_CC1ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER0_CC1ROUTE*/
#define _GPIO_TIMER0_CC1ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER0_CC1ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER0_CC1ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER0_CC1ROUTE       */
#define GPIO_TIMER0_CC1ROUTE_PIN_DEFAULT              (_GPIO_TIMER0_CC1ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER0_CC1ROUTE*/

/* Bit fields for GPIO_TIMER0 CC2ROUTE */
#define _GPIO_TIMER0_CC2ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER0_CC2ROUTE      */
#define _GPIO_TIMER0_CC2ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER0_CC2ROUTE               */
#define _GPIO_TIMER0_CC2ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER0_CC2ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER0_CC2ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER0_CC2ROUTE       */
#define GPIO_TIMER0_CC2ROUTE_PORT_DEFAULT             (_GPIO_TIMER0_CC2ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER0_CC2ROUTE*/
#define _GPIO_TIMER0_CC2ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER0_CC2ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER0_CC2ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER0_CC2ROUTE       */
#define GPIO_TIMER0_CC2ROUTE_PIN_DEFAULT              (_GPIO_TIMER0_CC2ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER0_CC2ROUTE*/

/* Bit fields for GPIO_TIMER0 CDTI0ROUTE */
#define _GPIO_TIMER0_CDTI0ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER0_CDTI0ROUTE    */
#define _GPIO_TIMER0_CDTI0ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER0_CDTI0ROUTE             */
#define _GPIO_TIMER0_CDTI0ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER0_CDTI0ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER0_CDTI0ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER0_CDTI0ROUTE     */
#define GPIO_TIMER0_CDTI0ROUTE_PORT_DEFAULT           (_GPIO_TIMER0_CDTI0ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER0_CDTI0ROUTE*/
#define _GPIO_TIMER0_CDTI0ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER0_CDTI0ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER0_CDTI0ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER0_CDTI0ROUTE     */
#define GPIO_TIMER0_CDTI0ROUTE_PIN_DEFAULT            (_GPIO_TIMER0_CDTI0ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER0_CDTI0ROUTE*/

/* Bit fields for GPIO_TIMER0 CDTI1ROUTE */
#define _GPIO_TIMER0_CDTI1ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER0_CDTI1ROUTE    */
#define _GPIO_TIMER0_CDTI1ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER0_CDTI1ROUTE             */
#define _GPIO_TIMER0_CDTI1ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER0_CDTI1ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER0_CDTI1ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER0_CDTI1ROUTE     */
#define GPIO_TIMER0_CDTI1ROUTE_PORT_DEFAULT           (_GPIO_TIMER0_CDTI1ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER0_CDTI1ROUTE*/
#define _GPIO_TIMER0_CDTI1ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER0_CDTI1ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER0_CDTI1ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER0_CDTI1ROUTE     */
#define GPIO_TIMER0_CDTI1ROUTE_PIN_DEFAULT            (_GPIO_TIMER0_CDTI1ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER0_CDTI1ROUTE*/

/* Bit fields for GPIO_TIMER0 CDTI2ROUTE */
#define _GPIO_TIMER0_CDTI2ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER0_CDTI2ROUTE    */
#define _GPIO_TIMER0_CDTI2ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER0_CDTI2ROUTE             */
#define _GPIO_TIMER0_CDTI2ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER0_CDTI2ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER0_CDTI2ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER0_CDTI2ROUTE     */
#define GPIO_TIMER0_CDTI2ROUTE_PORT_DEFAULT           (_GPIO_TIMER0_CDTI2ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER0_CDTI2ROUTE*/
#define _GPIO_TIMER0_CDTI2ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER0_CDTI2ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER0_CDTI2ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER0_CDTI2ROUTE     */
#define GPIO_TIMER0_CDTI2ROUTE_PIN_DEFAULT            (_GPIO_TIMER0_CDTI2ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER0_CDTI2ROUTE*/

/* Bit fields for GPIO_TIMER1 ROUTEEN */
#define _GPIO_TIMER1_ROUTEEN_RESETVALUE               0x00000000UL                                /**< Default value for GPIO_TIMER1_ROUTEEN       */
#define _GPIO_TIMER1_ROUTEEN_MASK                     0x0000003FUL                                /**< Mask for GPIO_TIMER1_ROUTEEN                */
#define GPIO_TIMER1_ROUTEEN_CC0PEN                    (0x1UL << 0)                                /**< CC0 pin enable control bit                  */
#define _GPIO_TIMER1_ROUTEEN_CC0PEN_SHIFT             0                                           /**< Shift value for GPIO_CC0PEN                 */
#define _GPIO_TIMER1_ROUTEEN_CC0PEN_MASK              0x1UL                                       /**< Bit mask for GPIO_CC0PEN                    */
#define _GPIO_TIMER1_ROUTEEN_CC0PEN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER1_ROUTEEN        */
#define GPIO_TIMER1_ROUTEEN_CC0PEN_DEFAULT            (_GPIO_TIMER1_ROUTEEN_CC0PEN_DEFAULT << 0)  /**< Shifted mode DEFAULT for GPIO_TIMER1_ROUTEEN*/
#define GPIO_TIMER1_ROUTEEN_CC1PEN                    (0x1UL << 1)                                /**< CC1 pin enable control bit                  */
#define _GPIO_TIMER1_ROUTEEN_CC1PEN_SHIFT             1                                           /**< Shift value for GPIO_CC1PEN                 */
#define _GPIO_TIMER1_ROUTEEN_CC1PEN_MASK              0x2UL                                       /**< Bit mask for GPIO_CC1PEN                    */
#define _GPIO_TIMER1_ROUTEEN_CC1PEN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER1_ROUTEEN        */
#define GPIO_TIMER1_ROUTEEN_CC1PEN_DEFAULT            (_GPIO_TIMER1_ROUTEEN_CC1PEN_DEFAULT << 1)  /**< Shifted mode DEFAULT for GPIO_TIMER1_ROUTEEN*/
#define GPIO_TIMER1_ROUTEEN_CC2PEN                    (0x1UL << 2)                                /**< CC2 pin enable control bit                  */
#define _GPIO_TIMER1_ROUTEEN_CC2PEN_SHIFT             2                                           /**< Shift value for GPIO_CC2PEN                 */
#define _GPIO_TIMER1_ROUTEEN_CC2PEN_MASK              0x4UL                                       /**< Bit mask for GPIO_CC2PEN                    */
#define _GPIO_TIMER1_ROUTEEN_CC2PEN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER1_ROUTEEN        */
#define GPIO_TIMER1_ROUTEEN_CC2PEN_DEFAULT            (_GPIO_TIMER1_ROUTEEN_CC2PEN_DEFAULT << 2)  /**< Shifted mode DEFAULT for GPIO_TIMER1_ROUTEEN*/
#define GPIO_TIMER1_ROUTEEN_CCC0PEN                   (0x1UL << 3)                                /**< CDTI0 pin enable control bit                */
#define _GPIO_TIMER1_ROUTEEN_CCC0PEN_SHIFT            3                                           /**< Shift value for GPIO_CCC0PEN                */
#define _GPIO_TIMER1_ROUTEEN_CCC0PEN_MASK             0x8UL                                       /**< Bit mask for GPIO_CCC0PEN                   */
#define _GPIO_TIMER1_ROUTEEN_CCC0PEN_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER1_ROUTEEN        */
#define GPIO_TIMER1_ROUTEEN_CCC0PEN_DEFAULT           (_GPIO_TIMER1_ROUTEEN_CCC0PEN_DEFAULT << 3) /**< Shifted mode DEFAULT for GPIO_TIMER1_ROUTEEN*/
#define GPIO_TIMER1_ROUTEEN_CCC1PEN                   (0x1UL << 4)                                /**< CDTI1 pin enable control bit                */
#define _GPIO_TIMER1_ROUTEEN_CCC1PEN_SHIFT            4                                           /**< Shift value for GPIO_CCC1PEN                */
#define _GPIO_TIMER1_ROUTEEN_CCC1PEN_MASK             0x10UL                                      /**< Bit mask for GPIO_CCC1PEN                   */
#define _GPIO_TIMER1_ROUTEEN_CCC1PEN_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER1_ROUTEEN        */
#define GPIO_TIMER1_ROUTEEN_CCC1PEN_DEFAULT           (_GPIO_TIMER1_ROUTEEN_CCC1PEN_DEFAULT << 4) /**< Shifted mode DEFAULT for GPIO_TIMER1_ROUTEEN*/
#define GPIO_TIMER1_ROUTEEN_CCC2PEN                   (0x1UL << 5)                                /**< CDTI2 pin enable control bit                */
#define _GPIO_TIMER1_ROUTEEN_CCC2PEN_SHIFT            5                                           /**< Shift value for GPIO_CCC2PEN                */
#define _GPIO_TIMER1_ROUTEEN_CCC2PEN_MASK             0x20UL                                      /**< Bit mask for GPIO_CCC2PEN                   */
#define _GPIO_TIMER1_ROUTEEN_CCC2PEN_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER1_ROUTEEN        */
#define GPIO_TIMER1_ROUTEEN_CCC2PEN_DEFAULT           (_GPIO_TIMER1_ROUTEEN_CCC2PEN_DEFAULT << 5) /**< Shifted mode DEFAULT for GPIO_TIMER1_ROUTEEN*/

/* Bit fields for GPIO_TIMER1 CC0ROUTE */
#define _GPIO_TIMER1_CC0ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER1_CC0ROUTE      */
#define _GPIO_TIMER1_CC0ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER1_CC0ROUTE               */
#define _GPIO_TIMER1_CC0ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER1_CC0ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER1_CC0ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER1_CC0ROUTE       */
#define GPIO_TIMER1_CC0ROUTE_PORT_DEFAULT             (_GPIO_TIMER1_CC0ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER1_CC0ROUTE*/
#define _GPIO_TIMER1_CC0ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER1_CC0ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER1_CC0ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER1_CC0ROUTE       */
#define GPIO_TIMER1_CC0ROUTE_PIN_DEFAULT              (_GPIO_TIMER1_CC0ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER1_CC0ROUTE*/

/* Bit fields for GPIO_TIMER1 CC1ROUTE */
#define _GPIO_TIMER1_CC1ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER1_CC1ROUTE      */
#define _GPIO_TIMER1_CC1ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER1_CC1ROUTE               */
#define _GPIO_TIMER1_CC1ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER1_CC1ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER1_CC1ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER1_CC1ROUTE       */
#define GPIO_TIMER1_CC1ROUTE_PORT_DEFAULT             (_GPIO_TIMER1_CC1ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER1_CC1ROUTE*/
#define _GPIO_TIMER1_CC1ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER1_CC1ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER1_CC1ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER1_CC1ROUTE       */
#define GPIO_TIMER1_CC1ROUTE_PIN_DEFAULT              (_GPIO_TIMER1_CC1ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER1_CC1ROUTE*/

/* Bit fields for GPIO_TIMER1 CC2ROUTE */
#define _GPIO_TIMER1_CC2ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER1_CC2ROUTE      */
#define _GPIO_TIMER1_CC2ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER1_CC2ROUTE               */
#define _GPIO_TIMER1_CC2ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER1_CC2ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER1_CC2ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER1_CC2ROUTE       */
#define GPIO_TIMER1_CC2ROUTE_PORT_DEFAULT             (_GPIO_TIMER1_CC2ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER1_CC2ROUTE*/
#define _GPIO_TIMER1_CC2ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER1_CC2ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER1_CC2ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER1_CC2ROUTE       */
#define GPIO_TIMER1_CC2ROUTE_PIN_DEFAULT              (_GPIO_TIMER1_CC2ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER1_CC2ROUTE*/

/* Bit fields for GPIO_TIMER1 CDTI0ROUTE */
#define _GPIO_TIMER1_CDTI0ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER1_CDTI0ROUTE    */
#define _GPIO_TIMER1_CDTI0ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER1_CDTI0ROUTE             */
#define _GPIO_TIMER1_CDTI0ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER1_CDTI0ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER1_CDTI0ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER1_CDTI0ROUTE     */
#define GPIO_TIMER1_CDTI0ROUTE_PORT_DEFAULT           (_GPIO_TIMER1_CDTI0ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER1_CDTI0ROUTE*/
#define _GPIO_TIMER1_CDTI0ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER1_CDTI0ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER1_CDTI0ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER1_CDTI0ROUTE     */
#define GPIO_TIMER1_CDTI0ROUTE_PIN_DEFAULT            (_GPIO_TIMER1_CDTI0ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER1_CDTI0ROUTE*/

/* Bit fields for GPIO_TIMER1 CDTI1ROUTE */
#define _GPIO_TIMER1_CDTI1ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER1_CDTI1ROUTE    */
#define _GPIO_TIMER1_CDTI1ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER1_CDTI1ROUTE             */
#define _GPIO_TIMER1_CDTI1ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER1_CDTI1ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER1_CDTI1ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER1_CDTI1ROUTE     */
#define GPIO_TIMER1_CDTI1ROUTE_PORT_DEFAULT           (_GPIO_TIMER1_CDTI1ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER1_CDTI1ROUTE*/
#define _GPIO_TIMER1_CDTI1ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER1_CDTI1ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER1_CDTI1ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER1_CDTI1ROUTE     */
#define GPIO_TIMER1_CDTI1ROUTE_PIN_DEFAULT            (_GPIO_TIMER1_CDTI1ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER1_CDTI1ROUTE*/

/* Bit fields for GPIO_TIMER1 CDTI2ROUTE */
#define _GPIO_TIMER1_CDTI2ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER1_CDTI2ROUTE    */
#define _GPIO_TIMER1_CDTI2ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER1_CDTI2ROUTE             */
#define _GPIO_TIMER1_CDTI2ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER1_CDTI2ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER1_CDTI2ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER1_CDTI2ROUTE     */
#define GPIO_TIMER1_CDTI2ROUTE_PORT_DEFAULT           (_GPIO_TIMER1_CDTI2ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER1_CDTI2ROUTE*/
#define _GPIO_TIMER1_CDTI2ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER1_CDTI2ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER1_CDTI2ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER1_CDTI2ROUTE     */
#define GPIO_TIMER1_CDTI2ROUTE_PIN_DEFAULT            (_GPIO_TIMER1_CDTI2ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER1_CDTI2ROUTE*/

/* Bit fields for GPIO_TIMER2 ROUTEEN */
#define _GPIO_TIMER2_ROUTEEN_RESETVALUE               0x00000000UL                                 /**< Default value for GPIO_TIMER2_ROUTEEN       */
#define _GPIO_TIMER2_ROUTEEN_MASK                     0x00003FFFUL                                 /**< Mask for GPIO_TIMER2_ROUTEEN                */
#define GPIO_TIMER2_ROUTEEN_CC0PEN                    (0x1UL << 0)                                 /**< CC0 pin enable control bit                  */
#define _GPIO_TIMER2_ROUTEEN_CC0PEN_SHIFT             0                                            /**< Shift value for GPIO_CC0PEN                 */
#define _GPIO_TIMER2_ROUTEEN_CC0PEN_MASK              0x1UL                                        /**< Bit mask for GPIO_CC0PEN                    */
#define _GPIO_TIMER2_ROUTEEN_CC0PEN_DEFAULT           0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER2_ROUTEEN        */
#define GPIO_TIMER2_ROUTEEN_CC0PEN_DEFAULT            (_GPIO_TIMER2_ROUTEEN_CC0PEN_DEFAULT << 0)   /**< Shifted mode DEFAULT for GPIO_TIMER2_ROUTEEN*/
#define GPIO_TIMER2_ROUTEEN_CC1PEN                    (0x1UL << 1)                                 /**< CC1 pin enable control bit                  */
#define _GPIO_TIMER2_ROUTEEN_CC1PEN_SHIFT             1                                            /**< Shift value for GPIO_CC1PEN                 */
#define _GPIO_TIMER2_ROUTEEN_CC1PEN_MASK              0x2UL                                        /**< Bit mask for GPIO_CC1PEN                    */
#define _GPIO_TIMER2_ROUTEEN_CC1PEN_DEFAULT           0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER2_ROUTEEN        */
#define GPIO_TIMER2_ROUTEEN_CC1PEN_DEFAULT            (_GPIO_TIMER2_ROUTEEN_CC1PEN_DEFAULT << 1)   /**< Shifted mode DEFAULT for GPIO_TIMER2_ROUTEEN*/
#define GPIO_TIMER2_ROUTEEN_CC2PEN                    (0x1UL << 2)                                 /**< CC2 pin enable control bit                  */
#define _GPIO_TIMER2_ROUTEEN_CC2PEN_SHIFT             2                                            /**< Shift value for GPIO_CC2PEN                 */
#define _GPIO_TIMER2_ROUTEEN_CC2PEN_MASK              0x4UL                                        /**< Bit mask for GPIO_CC2PEN                    */
#define _GPIO_TIMER2_ROUTEEN_CC2PEN_DEFAULT           0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER2_ROUTEEN        */
#define GPIO_TIMER2_ROUTEEN_CC2PEN_DEFAULT            (_GPIO_TIMER2_ROUTEEN_CC2PEN_DEFAULT << 2)   /**< Shifted mode DEFAULT for GPIO_TIMER2_ROUTEEN*/
#define GPIO_TIMER2_ROUTEEN_CC3PEN                    (0x1UL << 3)                                 /**< CC3 pin enable control bit                  */
#define _GPIO_TIMER2_ROUTEEN_CC3PEN_SHIFT             3                                            /**< Shift value for GPIO_CC3PEN                 */
#define _GPIO_TIMER2_ROUTEEN_CC3PEN_MASK              0x8UL                                        /**< Bit mask for GPIO_CC3PEN                    */
#define _GPIO_TIMER2_ROUTEEN_CC3PEN_DEFAULT           0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER2_ROUTEEN        */
#define GPIO_TIMER2_ROUTEEN_CC3PEN_DEFAULT            (_GPIO_TIMER2_ROUTEEN_CC3PEN_DEFAULT << 3)   /**< Shifted mode DEFAULT for GPIO_TIMER2_ROUTEEN*/
#define GPIO_TIMER2_ROUTEEN_CC4PEN                    (0x1UL << 4)                                 /**< CC4 pin enable control bit                  */
#define _GPIO_TIMER2_ROUTEEN_CC4PEN_SHIFT             4                                            /**< Shift value for GPIO_CC4PEN                 */
#define _GPIO_TIMER2_ROUTEEN_CC4PEN_MASK              0x10UL                                       /**< Bit mask for GPIO_CC4PEN                    */
#define _GPIO_TIMER2_ROUTEEN_CC4PEN_DEFAULT           0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER2_ROUTEEN        */
#define GPIO_TIMER2_ROUTEEN_CC4PEN_DEFAULT            (_GPIO_TIMER2_ROUTEEN_CC4PEN_DEFAULT << 4)   /**< Shifted mode DEFAULT for GPIO_TIMER2_ROUTEEN*/
#define GPIO_TIMER2_ROUTEEN_CC5PEN                    (0x1UL << 5)                                 /**< CC5 pin enable control bit                  */
#define _GPIO_TIMER2_ROUTEEN_CC5PEN_SHIFT             5                                            /**< Shift value for GPIO_CC5PEN                 */
#define _GPIO_TIMER2_ROUTEEN_CC5PEN_MASK              0x20UL                                       /**< Bit mask for GPIO_CC5PEN                    */
#define _GPIO_TIMER2_ROUTEEN_CC5PEN_DEFAULT           0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER2_ROUTEEN        */
#define GPIO_TIMER2_ROUTEEN_CC5PEN_DEFAULT            (_GPIO_TIMER2_ROUTEEN_CC5PEN_DEFAULT << 5)   /**< Shifted mode DEFAULT for GPIO_TIMER2_ROUTEEN*/
#define GPIO_TIMER2_ROUTEEN_CC6PEN                    (0x1UL << 6)                                 /**< CC6 pin enable control bit                  */
#define _GPIO_TIMER2_ROUTEEN_CC6PEN_SHIFT             6                                            /**< Shift value for GPIO_CC6PEN                 */
#define _GPIO_TIMER2_ROUTEEN_CC6PEN_MASK              0x40UL                                       /**< Bit mask for GPIO_CC6PEN                    */
#define _GPIO_TIMER2_ROUTEEN_CC6PEN_DEFAULT           0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER2_ROUTEEN        */
#define GPIO_TIMER2_ROUTEEN_CC6PEN_DEFAULT            (_GPIO_TIMER2_ROUTEEN_CC6PEN_DEFAULT << 6)   /**< Shifted mode DEFAULT for GPIO_TIMER2_ROUTEEN*/
#define GPIO_TIMER2_ROUTEEN_CCC0PEN                   (0x1UL << 7)                                 /**< CDTI0 pin enable control bit                */
#define _GPIO_TIMER2_ROUTEEN_CCC0PEN_SHIFT            7                                            /**< Shift value for GPIO_CCC0PEN                */
#define _GPIO_TIMER2_ROUTEEN_CCC0PEN_MASK             0x80UL                                       /**< Bit mask for GPIO_CCC0PEN                   */
#define _GPIO_TIMER2_ROUTEEN_CCC0PEN_DEFAULT          0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER2_ROUTEEN        */
#define GPIO_TIMER2_ROUTEEN_CCC0PEN_DEFAULT           (_GPIO_TIMER2_ROUTEEN_CCC0PEN_DEFAULT << 7)  /**< Shifted mode DEFAULT for GPIO_TIMER2_ROUTEEN*/
#define GPIO_TIMER2_ROUTEEN_CCC1PEN                   (0x1UL << 8)                                 /**< CDTI1 pin enable control bit                */
#define _GPIO_TIMER2_ROUTEEN_CCC1PEN_SHIFT            8                                            /**< Shift value for GPIO_CCC1PEN                */
#define _GPIO_TIMER2_ROUTEEN_CCC1PEN_MASK             0x100UL                                      /**< Bit mask for GPIO_CCC1PEN                   */
#define _GPIO_TIMER2_ROUTEEN_CCC1PEN_DEFAULT          0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER2_ROUTEEN        */
#define GPIO_TIMER2_ROUTEEN_CCC1PEN_DEFAULT           (_GPIO_TIMER2_ROUTEEN_CCC1PEN_DEFAULT << 8)  /**< Shifted mode DEFAULT for GPIO_TIMER2_ROUTEEN*/
#define GPIO_TIMER2_ROUTEEN_CCC2PEN                   (0x1UL << 9)                                 /**< CDTI2 pin enable control bit                */
#define _GPIO_TIMER2_ROUTEEN_CCC2PEN_SHIFT            9                                            /**< Shift value for GPIO_CCC2PEN                */
#define _GPIO_TIMER2_ROUTEEN_CCC2PEN_MASK             0x200UL                                      /**< Bit mask for GPIO_CCC2PEN                   */
#define _GPIO_TIMER2_ROUTEEN_CCC2PEN_DEFAULT          0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER2_ROUTEEN        */
#define GPIO_TIMER2_ROUTEEN_CCC2PEN_DEFAULT           (_GPIO_TIMER2_ROUTEEN_CCC2PEN_DEFAULT << 9)  /**< Shifted mode DEFAULT for GPIO_TIMER2_ROUTEEN*/
#define GPIO_TIMER2_ROUTEEN_CCC3PEN                   (0x1UL << 10)                                /**< CDTI3 pin enable control bit                */
#define _GPIO_TIMER2_ROUTEEN_CCC3PEN_SHIFT            10                                           /**< Shift value for GPIO_CCC3PEN                */
#define _GPIO_TIMER2_ROUTEEN_CCC3PEN_MASK             0x400UL                                      /**< Bit mask for GPIO_CCC3PEN                   */
#define _GPIO_TIMER2_ROUTEEN_CCC3PEN_DEFAULT          0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER2_ROUTEEN        */
#define GPIO_TIMER2_ROUTEEN_CCC3PEN_DEFAULT           (_GPIO_TIMER2_ROUTEEN_CCC3PEN_DEFAULT << 10) /**< Shifted mode DEFAULT for GPIO_TIMER2_ROUTEEN*/
#define GPIO_TIMER2_ROUTEEN_CCC4PEN                   (0x1UL << 11)                                /**< CDTI4 pin enable control bit                */
#define _GPIO_TIMER2_ROUTEEN_CCC4PEN_SHIFT            11                                           /**< Shift value for GPIO_CCC4PEN                */
#define _GPIO_TIMER2_ROUTEEN_CCC4PEN_MASK             0x800UL                                      /**< Bit mask for GPIO_CCC4PEN                   */
#define _GPIO_TIMER2_ROUTEEN_CCC4PEN_DEFAULT          0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER2_ROUTEEN        */
#define GPIO_TIMER2_ROUTEEN_CCC4PEN_DEFAULT           (_GPIO_TIMER2_ROUTEEN_CCC4PEN_DEFAULT << 11) /**< Shifted mode DEFAULT for GPIO_TIMER2_ROUTEEN*/
#define GPIO_TIMER2_ROUTEEN_CCC5PEN                   (0x1UL << 12)                                /**< CDTI5 pin enable control bit                */
#define _GPIO_TIMER2_ROUTEEN_CCC5PEN_SHIFT            12                                           /**< Shift value for GPIO_CCC5PEN                */
#define _GPIO_TIMER2_ROUTEEN_CCC5PEN_MASK             0x1000UL                                     /**< Bit mask for GPIO_CCC5PEN                   */
#define _GPIO_TIMER2_ROUTEEN_CCC5PEN_DEFAULT          0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER2_ROUTEEN        */
#define GPIO_TIMER2_ROUTEEN_CCC5PEN_DEFAULT           (_GPIO_TIMER2_ROUTEEN_CCC5PEN_DEFAULT << 12) /**< Shifted mode DEFAULT for GPIO_TIMER2_ROUTEEN*/
#define GPIO_TIMER2_ROUTEEN_CCC6PEN                   (0x1UL << 13)                                /**< CDTI6 pin enable control bit                */
#define _GPIO_TIMER2_ROUTEEN_CCC6PEN_SHIFT            13                                           /**< Shift value for GPIO_CCC6PEN                */
#define _GPIO_TIMER2_ROUTEEN_CCC6PEN_MASK             0x2000UL                                     /**< Bit mask for GPIO_CCC6PEN                   */
#define _GPIO_TIMER2_ROUTEEN_CCC6PEN_DEFAULT          0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER2_ROUTEEN        */
#define GPIO_TIMER2_ROUTEEN_CCC6PEN_DEFAULT           (_GPIO_TIMER2_ROUTEEN_CCC6PEN_DEFAULT << 13) /**< Shifted mode DEFAULT for GPIO_TIMER2_ROUTEEN*/

/* Bit fields for GPIO_TIMER2 CC0ROUTE */
#define _GPIO_TIMER2_CC0ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER2_CC0ROUTE      */
#define _GPIO_TIMER2_CC0ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER2_CC0ROUTE               */
#define _GPIO_TIMER2_CC0ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER2_CC0ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER2_CC0ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER2_CC0ROUTE       */
#define GPIO_TIMER2_CC0ROUTE_PORT_DEFAULT             (_GPIO_TIMER2_CC0ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER2_CC0ROUTE*/
#define _GPIO_TIMER2_CC0ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER2_CC0ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER2_CC0ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER2_CC0ROUTE       */
#define GPIO_TIMER2_CC0ROUTE_PIN_DEFAULT              (_GPIO_TIMER2_CC0ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER2_CC0ROUTE*/

/* Bit fields for GPIO_TIMER2 CC1ROUTE */
#define _GPIO_TIMER2_CC1ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER2_CC1ROUTE      */
#define _GPIO_TIMER2_CC1ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER2_CC1ROUTE               */
#define _GPIO_TIMER2_CC1ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER2_CC1ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER2_CC1ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER2_CC1ROUTE       */
#define GPIO_TIMER2_CC1ROUTE_PORT_DEFAULT             (_GPIO_TIMER2_CC1ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER2_CC1ROUTE*/
#define _GPIO_TIMER2_CC1ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER2_CC1ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER2_CC1ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER2_CC1ROUTE       */
#define GPIO_TIMER2_CC1ROUTE_PIN_DEFAULT              (_GPIO_TIMER2_CC1ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER2_CC1ROUTE*/

/* Bit fields for GPIO_TIMER2 CC2ROUTE */
#define _GPIO_TIMER2_CC2ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER2_CC2ROUTE      */
#define _GPIO_TIMER2_CC2ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER2_CC2ROUTE               */
#define _GPIO_TIMER2_CC2ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER2_CC2ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER2_CC2ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER2_CC2ROUTE       */
#define GPIO_TIMER2_CC2ROUTE_PORT_DEFAULT             (_GPIO_TIMER2_CC2ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER2_CC2ROUTE*/
#define _GPIO_TIMER2_CC2ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER2_CC2ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER2_CC2ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER2_CC2ROUTE       */
#define GPIO_TIMER2_CC2ROUTE_PIN_DEFAULT              (_GPIO_TIMER2_CC2ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER2_CC2ROUTE*/

/* Bit fields for GPIO_TIMER2 CC3ROUTE */
#define _GPIO_TIMER2_CC3ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER2_CC3ROUTE      */
#define _GPIO_TIMER2_CC3ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER2_CC3ROUTE               */
#define _GPIO_TIMER2_CC3ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER2_CC3ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER2_CC3ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER2_CC3ROUTE       */
#define GPIO_TIMER2_CC3ROUTE_PORT_DEFAULT             (_GPIO_TIMER2_CC3ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER2_CC3ROUTE*/
#define _GPIO_TIMER2_CC3ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER2_CC3ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER2_CC3ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER2_CC3ROUTE       */
#define GPIO_TIMER2_CC3ROUTE_PIN_DEFAULT              (_GPIO_TIMER2_CC3ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER2_CC3ROUTE*/

/* Bit fields for GPIO_TIMER2 CC4ROUTE */
#define _GPIO_TIMER2_CC4ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER2_CC4ROUTE      */
#define _GPIO_TIMER2_CC4ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER2_CC4ROUTE               */
#define _GPIO_TIMER2_CC4ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER2_CC4ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER2_CC4ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER2_CC4ROUTE       */
#define GPIO_TIMER2_CC4ROUTE_PORT_DEFAULT             (_GPIO_TIMER2_CC4ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER2_CC4ROUTE*/
#define _GPIO_TIMER2_CC4ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER2_CC4ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER2_CC4ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER2_CC4ROUTE       */
#define GPIO_TIMER2_CC4ROUTE_PIN_DEFAULT              (_GPIO_TIMER2_CC4ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER2_CC4ROUTE*/

/* Bit fields for GPIO_TIMER2 CC5ROUTE */
#define _GPIO_TIMER2_CC5ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER2_CC5ROUTE      */
#define _GPIO_TIMER2_CC5ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER2_CC5ROUTE               */
#define _GPIO_TIMER2_CC5ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER2_CC5ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER2_CC5ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER2_CC5ROUTE       */
#define GPIO_TIMER2_CC5ROUTE_PORT_DEFAULT             (_GPIO_TIMER2_CC5ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER2_CC5ROUTE*/
#define _GPIO_TIMER2_CC5ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER2_CC5ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER2_CC5ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER2_CC5ROUTE       */
#define GPIO_TIMER2_CC5ROUTE_PIN_DEFAULT              (_GPIO_TIMER2_CC5ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER2_CC5ROUTE*/

/* Bit fields for GPIO_TIMER2 CC6ROUTE */
#define _GPIO_TIMER2_CC6ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER2_CC6ROUTE      */
#define _GPIO_TIMER2_CC6ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER2_CC6ROUTE               */
#define _GPIO_TIMER2_CC6ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER2_CC6ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER2_CC6ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER2_CC6ROUTE       */
#define GPIO_TIMER2_CC6ROUTE_PORT_DEFAULT             (_GPIO_TIMER2_CC6ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER2_CC6ROUTE*/
#define _GPIO_TIMER2_CC6ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER2_CC6ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER2_CC6ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER2_CC6ROUTE       */
#define GPIO_TIMER2_CC6ROUTE_PIN_DEFAULT              (_GPIO_TIMER2_CC6ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER2_CC6ROUTE*/

/* Bit fields for GPIO_TIMER2 CDTI0ROUTE */
#define _GPIO_TIMER2_CDTI0ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER2_CDTI0ROUTE    */
#define _GPIO_TIMER2_CDTI0ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER2_CDTI0ROUTE             */
#define _GPIO_TIMER2_CDTI0ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER2_CDTI0ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER2_CDTI0ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER2_CDTI0ROUTE     */
#define GPIO_TIMER2_CDTI0ROUTE_PORT_DEFAULT           (_GPIO_TIMER2_CDTI0ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER2_CDTI0ROUTE*/
#define _GPIO_TIMER2_CDTI0ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER2_CDTI0ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER2_CDTI0ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER2_CDTI0ROUTE     */
#define GPIO_TIMER2_CDTI0ROUTE_PIN_DEFAULT            (_GPIO_TIMER2_CDTI0ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER2_CDTI0ROUTE*/

/* Bit fields for GPIO_TIMER2 CDTI1ROUTE */
#define _GPIO_TIMER2_CDTI1ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER2_CDTI1ROUTE    */
#define _GPIO_TIMER2_CDTI1ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER2_CDTI1ROUTE             */
#define _GPIO_TIMER2_CDTI1ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER2_CDTI1ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER2_CDTI1ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER2_CDTI1ROUTE     */
#define GPIO_TIMER2_CDTI1ROUTE_PORT_DEFAULT           (_GPIO_TIMER2_CDTI1ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER2_CDTI1ROUTE*/
#define _GPIO_TIMER2_CDTI1ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER2_CDTI1ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER2_CDTI1ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER2_CDTI1ROUTE     */
#define GPIO_TIMER2_CDTI1ROUTE_PIN_DEFAULT            (_GPIO_TIMER2_CDTI1ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER2_CDTI1ROUTE*/

/* Bit fields for GPIO_TIMER2 CDTI2ROUTE */
#define _GPIO_TIMER2_CDTI2ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER2_CDTI2ROUTE    */
#define _GPIO_TIMER2_CDTI2ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER2_CDTI2ROUTE             */
#define _GPIO_TIMER2_CDTI2ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER2_CDTI2ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER2_CDTI2ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER2_CDTI2ROUTE     */
#define GPIO_TIMER2_CDTI2ROUTE_PORT_DEFAULT           (_GPIO_TIMER2_CDTI2ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER2_CDTI2ROUTE*/
#define _GPIO_TIMER2_CDTI2ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER2_CDTI2ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER2_CDTI2ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER2_CDTI2ROUTE     */
#define GPIO_TIMER2_CDTI2ROUTE_PIN_DEFAULT            (_GPIO_TIMER2_CDTI2ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER2_CDTI2ROUTE*/

/* Bit fields for GPIO_TIMER2 CDTI3ROUTE */
#define _GPIO_TIMER2_CDTI3ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER2_CDTI3ROUTE    */
#define _GPIO_TIMER2_CDTI3ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER2_CDTI3ROUTE             */
#define _GPIO_TIMER2_CDTI3ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER2_CDTI3ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER2_CDTI3ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER2_CDTI3ROUTE     */
#define GPIO_TIMER2_CDTI3ROUTE_PORT_DEFAULT           (_GPIO_TIMER2_CDTI3ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER2_CDTI3ROUTE*/
#define _GPIO_TIMER2_CDTI3ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER2_CDTI3ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER2_CDTI3ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER2_CDTI3ROUTE     */
#define GPIO_TIMER2_CDTI3ROUTE_PIN_DEFAULT            (_GPIO_TIMER2_CDTI3ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER2_CDTI3ROUTE*/

/* Bit fields for GPIO_TIMER2 CDTI4ROUTE */
#define _GPIO_TIMER2_CDTI4ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER2_CDTI4ROUTE    */
#define _GPIO_TIMER2_CDTI4ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER2_CDTI4ROUTE             */
#define _GPIO_TIMER2_CDTI4ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER2_CDTI4ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER2_CDTI4ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER2_CDTI4ROUTE     */
#define GPIO_TIMER2_CDTI4ROUTE_PORT_DEFAULT           (_GPIO_TIMER2_CDTI4ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER2_CDTI4ROUTE*/
#define _GPIO_TIMER2_CDTI4ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER2_CDTI4ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER2_CDTI4ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER2_CDTI4ROUTE     */
#define GPIO_TIMER2_CDTI4ROUTE_PIN_DEFAULT            (_GPIO_TIMER2_CDTI4ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER2_CDTI4ROUTE*/

/* Bit fields for GPIO_TIMER2 CDTI5ROUTE */
#define _GPIO_TIMER2_CDTI5ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER2_CDTI5ROUTE    */
#define _GPIO_TIMER2_CDTI5ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER2_CDTI5ROUTE             */
#define _GPIO_TIMER2_CDTI5ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER2_CDTI5ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER2_CDTI5ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER2_CDTI5ROUTE     */
#define GPIO_TIMER2_CDTI5ROUTE_PORT_DEFAULT           (_GPIO_TIMER2_CDTI5ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER2_CDTI5ROUTE*/
#define _GPIO_TIMER2_CDTI5ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER2_CDTI5ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER2_CDTI5ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER2_CDTI5ROUTE     */
#define GPIO_TIMER2_CDTI5ROUTE_PIN_DEFAULT            (_GPIO_TIMER2_CDTI5ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER2_CDTI5ROUTE*/

/* Bit fields for GPIO_TIMER2 CDTI6ROUTE */
#define _GPIO_TIMER2_CDTI6ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER2_CDTI6ROUTE    */
#define _GPIO_TIMER2_CDTI6ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER2_CDTI6ROUTE             */
#define _GPIO_TIMER2_CDTI6ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER2_CDTI6ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER2_CDTI6ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER2_CDTI6ROUTE     */
#define GPIO_TIMER2_CDTI6ROUTE_PORT_DEFAULT           (_GPIO_TIMER2_CDTI6ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER2_CDTI6ROUTE*/
#define _GPIO_TIMER2_CDTI6ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER2_CDTI6ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER2_CDTI6ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER2_CDTI6ROUTE     */
#define GPIO_TIMER2_CDTI6ROUTE_PIN_DEFAULT            (_GPIO_TIMER2_CDTI6ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER2_CDTI6ROUTE*/

/* Bit fields for GPIO_TIMER3 ROUTEEN */
#define _GPIO_TIMER3_ROUTEEN_RESETVALUE               0x00000000UL                                 /**< Default value for GPIO_TIMER3_ROUTEEN       */
#define _GPIO_TIMER3_ROUTEEN_MASK                     0x00003FFFUL                                 /**< Mask for GPIO_TIMER3_ROUTEEN                */
#define GPIO_TIMER3_ROUTEEN_CC0PEN                    (0x1UL << 0)                                 /**< CC0 pin enable control bit                  */
#define _GPIO_TIMER3_ROUTEEN_CC0PEN_SHIFT             0                                            /**< Shift value for GPIO_CC0PEN                 */
#define _GPIO_TIMER3_ROUTEEN_CC0PEN_MASK              0x1UL                                        /**< Bit mask for GPIO_CC0PEN                    */
#define _GPIO_TIMER3_ROUTEEN_CC0PEN_DEFAULT           0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER3_ROUTEEN        */
#define GPIO_TIMER3_ROUTEEN_CC0PEN_DEFAULT            (_GPIO_TIMER3_ROUTEEN_CC0PEN_DEFAULT << 0)   /**< Shifted mode DEFAULT for GPIO_TIMER3_ROUTEEN*/
#define GPIO_TIMER3_ROUTEEN_CC1PEN                    (0x1UL << 1)                                 /**< CC1 pin enable control bit                  */
#define _GPIO_TIMER3_ROUTEEN_CC1PEN_SHIFT             1                                            /**< Shift value for GPIO_CC1PEN                 */
#define _GPIO_TIMER3_ROUTEEN_CC1PEN_MASK              0x2UL                                        /**< Bit mask for GPIO_CC1PEN                    */
#define _GPIO_TIMER3_ROUTEEN_CC1PEN_DEFAULT           0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER3_ROUTEEN        */
#define GPIO_TIMER3_ROUTEEN_CC1PEN_DEFAULT            (_GPIO_TIMER3_ROUTEEN_CC1PEN_DEFAULT << 1)   /**< Shifted mode DEFAULT for GPIO_TIMER3_ROUTEEN*/
#define GPIO_TIMER3_ROUTEEN_CC2PEN                    (0x1UL << 2)                                 /**< CC2 pin enable control bit                  */
#define _GPIO_TIMER3_ROUTEEN_CC2PEN_SHIFT             2                                            /**< Shift value for GPIO_CC2PEN                 */
#define _GPIO_TIMER3_ROUTEEN_CC2PEN_MASK              0x4UL                                        /**< Bit mask for GPIO_CC2PEN                    */
#define _GPIO_TIMER3_ROUTEEN_CC2PEN_DEFAULT           0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER3_ROUTEEN        */
#define GPIO_TIMER3_ROUTEEN_CC2PEN_DEFAULT            (_GPIO_TIMER3_ROUTEEN_CC2PEN_DEFAULT << 2)   /**< Shifted mode DEFAULT for GPIO_TIMER3_ROUTEEN*/
#define GPIO_TIMER3_ROUTEEN_CC3PEN                    (0x1UL << 3)                                 /**< CC3 pin enable control bit                  */
#define _GPIO_TIMER3_ROUTEEN_CC3PEN_SHIFT             3                                            /**< Shift value for GPIO_CC3PEN                 */
#define _GPIO_TIMER3_ROUTEEN_CC3PEN_MASK              0x8UL                                        /**< Bit mask for GPIO_CC3PEN                    */
#define _GPIO_TIMER3_ROUTEEN_CC3PEN_DEFAULT           0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER3_ROUTEEN        */
#define GPIO_TIMER3_ROUTEEN_CC3PEN_DEFAULT            (_GPIO_TIMER3_ROUTEEN_CC3PEN_DEFAULT << 3)   /**< Shifted mode DEFAULT for GPIO_TIMER3_ROUTEEN*/
#define GPIO_TIMER3_ROUTEEN_CC4PEN                    (0x1UL << 4)                                 /**< CC4 pin enable control bit                  */
#define _GPIO_TIMER3_ROUTEEN_CC4PEN_SHIFT             4                                            /**< Shift value for GPIO_CC4PEN                 */
#define _GPIO_TIMER3_ROUTEEN_CC4PEN_MASK              0x10UL                                       /**< Bit mask for GPIO_CC4PEN                    */
#define _GPIO_TIMER3_ROUTEEN_CC4PEN_DEFAULT           0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER3_ROUTEEN        */
#define GPIO_TIMER3_ROUTEEN_CC4PEN_DEFAULT            (_GPIO_TIMER3_ROUTEEN_CC4PEN_DEFAULT << 4)   /**< Shifted mode DEFAULT for GPIO_TIMER3_ROUTEEN*/
#define GPIO_TIMER3_ROUTEEN_CC5PEN                    (0x1UL << 5)                                 /**< CC5 pin enable control bit                  */
#define _GPIO_TIMER3_ROUTEEN_CC5PEN_SHIFT             5                                            /**< Shift value for GPIO_CC5PEN                 */
#define _GPIO_TIMER3_ROUTEEN_CC5PEN_MASK              0x20UL                                       /**< Bit mask for GPIO_CC5PEN                    */
#define _GPIO_TIMER3_ROUTEEN_CC5PEN_DEFAULT           0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER3_ROUTEEN        */
#define GPIO_TIMER3_ROUTEEN_CC5PEN_DEFAULT            (_GPIO_TIMER3_ROUTEEN_CC5PEN_DEFAULT << 5)   /**< Shifted mode DEFAULT for GPIO_TIMER3_ROUTEEN*/
#define GPIO_TIMER3_ROUTEEN_CC6PEN                    (0x1UL << 6)                                 /**< CC6 pin enable control bit                  */
#define _GPIO_TIMER3_ROUTEEN_CC6PEN_SHIFT             6                                            /**< Shift value for GPIO_CC6PEN                 */
#define _GPIO_TIMER3_ROUTEEN_CC6PEN_MASK              0x40UL                                       /**< Bit mask for GPIO_CC6PEN                    */
#define _GPIO_TIMER3_ROUTEEN_CC6PEN_DEFAULT           0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER3_ROUTEEN        */
#define GPIO_TIMER3_ROUTEEN_CC6PEN_DEFAULT            (_GPIO_TIMER3_ROUTEEN_CC6PEN_DEFAULT << 6)   /**< Shifted mode DEFAULT for GPIO_TIMER3_ROUTEEN*/
#define GPIO_TIMER3_ROUTEEN_CCC0PEN                   (0x1UL << 7)                                 /**< CDTI0 pin enable control bit                */
#define _GPIO_TIMER3_ROUTEEN_CCC0PEN_SHIFT            7                                            /**< Shift value for GPIO_CCC0PEN                */
#define _GPIO_TIMER3_ROUTEEN_CCC0PEN_MASK             0x80UL                                       /**< Bit mask for GPIO_CCC0PEN                   */
#define _GPIO_TIMER3_ROUTEEN_CCC0PEN_DEFAULT          0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER3_ROUTEEN        */
#define GPIO_TIMER3_ROUTEEN_CCC0PEN_DEFAULT           (_GPIO_TIMER3_ROUTEEN_CCC0PEN_DEFAULT << 7)  /**< Shifted mode DEFAULT for GPIO_TIMER3_ROUTEEN*/
#define GPIO_TIMER3_ROUTEEN_CCC1PEN                   (0x1UL << 8)                                 /**< CDTI1 pin enable control bit                */
#define _GPIO_TIMER3_ROUTEEN_CCC1PEN_SHIFT            8                                            /**< Shift value for GPIO_CCC1PEN                */
#define _GPIO_TIMER3_ROUTEEN_CCC1PEN_MASK             0x100UL                                      /**< Bit mask for GPIO_CCC1PEN                   */
#define _GPIO_TIMER3_ROUTEEN_CCC1PEN_DEFAULT          0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER3_ROUTEEN        */
#define GPIO_TIMER3_ROUTEEN_CCC1PEN_DEFAULT           (_GPIO_TIMER3_ROUTEEN_CCC1PEN_DEFAULT << 8)  /**< Shifted mode DEFAULT for GPIO_TIMER3_ROUTEEN*/
#define GPIO_TIMER3_ROUTEEN_CCC2PEN                   (0x1UL << 9)                                 /**< CDTI2 pin enable control bit                */
#define _GPIO_TIMER3_ROUTEEN_CCC2PEN_SHIFT            9                                            /**< Shift value for GPIO_CCC2PEN                */
#define _GPIO_TIMER3_ROUTEEN_CCC2PEN_MASK             0x200UL                                      /**< Bit mask for GPIO_CCC2PEN                   */
#define _GPIO_TIMER3_ROUTEEN_CCC2PEN_DEFAULT          0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER3_ROUTEEN        */
#define GPIO_TIMER3_ROUTEEN_CCC2PEN_DEFAULT           (_GPIO_TIMER3_ROUTEEN_CCC2PEN_DEFAULT << 9)  /**< Shifted mode DEFAULT for GPIO_TIMER3_ROUTEEN*/
#define GPIO_TIMER3_ROUTEEN_CCC3PEN                   (0x1UL << 10)                                /**< CDTI3 pin enable control bit                */
#define _GPIO_TIMER3_ROUTEEN_CCC3PEN_SHIFT            10                                           /**< Shift value for GPIO_CCC3PEN                */
#define _GPIO_TIMER3_ROUTEEN_CCC3PEN_MASK             0x400UL                                      /**< Bit mask for GPIO_CCC3PEN                   */
#define _GPIO_TIMER3_ROUTEEN_CCC3PEN_DEFAULT          0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER3_ROUTEEN        */
#define GPIO_TIMER3_ROUTEEN_CCC3PEN_DEFAULT           (_GPIO_TIMER3_ROUTEEN_CCC3PEN_DEFAULT << 10) /**< Shifted mode DEFAULT for GPIO_TIMER3_ROUTEEN*/
#define GPIO_TIMER3_ROUTEEN_CCC4PEN                   (0x1UL << 11)                                /**< CDTI4 pin enable control bit                */
#define _GPIO_TIMER3_ROUTEEN_CCC4PEN_SHIFT            11                                           /**< Shift value for GPIO_CCC4PEN                */
#define _GPIO_TIMER3_ROUTEEN_CCC4PEN_MASK             0x800UL                                      /**< Bit mask for GPIO_CCC4PEN                   */
#define _GPIO_TIMER3_ROUTEEN_CCC4PEN_DEFAULT          0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER3_ROUTEEN        */
#define GPIO_TIMER3_ROUTEEN_CCC4PEN_DEFAULT           (_GPIO_TIMER3_ROUTEEN_CCC4PEN_DEFAULT << 11) /**< Shifted mode DEFAULT for GPIO_TIMER3_ROUTEEN*/
#define GPIO_TIMER3_ROUTEEN_CCC5PEN                   (0x1UL << 12)                                /**< CDTI5 pin enable control bit                */
#define _GPIO_TIMER3_ROUTEEN_CCC5PEN_SHIFT            12                                           /**< Shift value for GPIO_CCC5PEN                */
#define _GPIO_TIMER3_ROUTEEN_CCC5PEN_MASK             0x1000UL                                     /**< Bit mask for GPIO_CCC5PEN                   */
#define _GPIO_TIMER3_ROUTEEN_CCC5PEN_DEFAULT          0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER3_ROUTEEN        */
#define GPIO_TIMER3_ROUTEEN_CCC5PEN_DEFAULT           (_GPIO_TIMER3_ROUTEEN_CCC5PEN_DEFAULT << 12) /**< Shifted mode DEFAULT for GPIO_TIMER3_ROUTEEN*/
#define GPIO_TIMER3_ROUTEEN_CCC6PEN                   (0x1UL << 13)                                /**< CDTI6 pin enable control bit                */
#define _GPIO_TIMER3_ROUTEEN_CCC6PEN_SHIFT            13                                           /**< Shift value for GPIO_CCC6PEN                */
#define _GPIO_TIMER3_ROUTEEN_CCC6PEN_MASK             0x2000UL                                     /**< Bit mask for GPIO_CCC6PEN                   */
#define _GPIO_TIMER3_ROUTEEN_CCC6PEN_DEFAULT          0x00000000UL                                 /**< Mode DEFAULT for GPIO_TIMER3_ROUTEEN        */
#define GPIO_TIMER3_ROUTEEN_CCC6PEN_DEFAULT           (_GPIO_TIMER3_ROUTEEN_CCC6PEN_DEFAULT << 13) /**< Shifted mode DEFAULT for GPIO_TIMER3_ROUTEEN*/

/* Bit fields for GPIO_TIMER3 CC0ROUTE */
#define _GPIO_TIMER3_CC0ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER3_CC0ROUTE      */
#define _GPIO_TIMER3_CC0ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER3_CC0ROUTE               */
#define _GPIO_TIMER3_CC0ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER3_CC0ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER3_CC0ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER3_CC0ROUTE       */
#define GPIO_TIMER3_CC0ROUTE_PORT_DEFAULT             (_GPIO_TIMER3_CC0ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER3_CC0ROUTE*/
#define _GPIO_TIMER3_CC0ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER3_CC0ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER3_CC0ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER3_CC0ROUTE       */
#define GPIO_TIMER3_CC0ROUTE_PIN_DEFAULT              (_GPIO_TIMER3_CC0ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER3_CC0ROUTE*/

/* Bit fields for GPIO_TIMER3 CC1ROUTE */
#define _GPIO_TIMER3_CC1ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER3_CC1ROUTE      */
#define _GPIO_TIMER3_CC1ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER3_CC1ROUTE               */
#define _GPIO_TIMER3_CC1ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER3_CC1ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER3_CC1ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER3_CC1ROUTE       */
#define GPIO_TIMER3_CC1ROUTE_PORT_DEFAULT             (_GPIO_TIMER3_CC1ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER3_CC1ROUTE*/
#define _GPIO_TIMER3_CC1ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER3_CC1ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER3_CC1ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER3_CC1ROUTE       */
#define GPIO_TIMER3_CC1ROUTE_PIN_DEFAULT              (_GPIO_TIMER3_CC1ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER3_CC1ROUTE*/

/* Bit fields for GPIO_TIMER3 CC2ROUTE */
#define _GPIO_TIMER3_CC2ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER3_CC2ROUTE      */
#define _GPIO_TIMER3_CC2ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER3_CC2ROUTE               */
#define _GPIO_TIMER3_CC2ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER3_CC2ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER3_CC2ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER3_CC2ROUTE       */
#define GPIO_TIMER3_CC2ROUTE_PORT_DEFAULT             (_GPIO_TIMER3_CC2ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER3_CC2ROUTE*/
#define _GPIO_TIMER3_CC2ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER3_CC2ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER3_CC2ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER3_CC2ROUTE       */
#define GPIO_TIMER3_CC2ROUTE_PIN_DEFAULT              (_GPIO_TIMER3_CC2ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER3_CC2ROUTE*/

/* Bit fields for GPIO_TIMER3 CC3ROUTE */
#define _GPIO_TIMER3_CC3ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER3_CC3ROUTE      */
#define _GPIO_TIMER3_CC3ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER3_CC3ROUTE               */
#define _GPIO_TIMER3_CC3ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER3_CC3ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER3_CC3ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER3_CC3ROUTE       */
#define GPIO_TIMER3_CC3ROUTE_PORT_DEFAULT             (_GPIO_TIMER3_CC3ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER3_CC3ROUTE*/
#define _GPIO_TIMER3_CC3ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER3_CC3ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER3_CC3ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER3_CC3ROUTE       */
#define GPIO_TIMER3_CC3ROUTE_PIN_DEFAULT              (_GPIO_TIMER3_CC3ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER3_CC3ROUTE*/

/* Bit fields for GPIO_TIMER3 CC4ROUTE */
#define _GPIO_TIMER3_CC4ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER3_CC4ROUTE      */
#define _GPIO_TIMER3_CC4ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER3_CC4ROUTE               */
#define _GPIO_TIMER3_CC4ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER3_CC4ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER3_CC4ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER3_CC4ROUTE       */
#define GPIO_TIMER3_CC4ROUTE_PORT_DEFAULT             (_GPIO_TIMER3_CC4ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER3_CC4ROUTE*/
#define _GPIO_TIMER3_CC4ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER3_CC4ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER3_CC4ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER3_CC4ROUTE       */
#define GPIO_TIMER3_CC4ROUTE_PIN_DEFAULT              (_GPIO_TIMER3_CC4ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER3_CC4ROUTE*/

/* Bit fields for GPIO_TIMER3 CC5ROUTE */
#define _GPIO_TIMER3_CC5ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER3_CC5ROUTE      */
#define _GPIO_TIMER3_CC5ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER3_CC5ROUTE               */
#define _GPIO_TIMER3_CC5ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER3_CC5ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER3_CC5ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER3_CC5ROUTE       */
#define GPIO_TIMER3_CC5ROUTE_PORT_DEFAULT             (_GPIO_TIMER3_CC5ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER3_CC5ROUTE*/
#define _GPIO_TIMER3_CC5ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER3_CC5ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER3_CC5ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER3_CC5ROUTE       */
#define GPIO_TIMER3_CC5ROUTE_PIN_DEFAULT              (_GPIO_TIMER3_CC5ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER3_CC5ROUTE*/

/* Bit fields for GPIO_TIMER3 CC6ROUTE */
#define _GPIO_TIMER3_CC6ROUTE_RESETVALUE              0x00000000UL                              /**< Default value for GPIO_TIMER3_CC6ROUTE      */
#define _GPIO_TIMER3_CC6ROUTE_MASK                    0x000F0003UL                              /**< Mask for GPIO_TIMER3_CC6ROUTE               */
#define _GPIO_TIMER3_CC6ROUTE_PORT_SHIFT              0                                         /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER3_CC6ROUTE_PORT_MASK               0x3UL                                     /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER3_CC6ROUTE_PORT_DEFAULT            0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER3_CC6ROUTE       */
#define GPIO_TIMER3_CC6ROUTE_PORT_DEFAULT             (_GPIO_TIMER3_CC6ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER3_CC6ROUTE*/
#define _GPIO_TIMER3_CC6ROUTE_PIN_SHIFT               16                                        /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER3_CC6ROUTE_PIN_MASK                0xF0000UL                                 /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER3_CC6ROUTE_PIN_DEFAULT             0x00000000UL                              /**< Mode DEFAULT for GPIO_TIMER3_CC6ROUTE       */
#define GPIO_TIMER3_CC6ROUTE_PIN_DEFAULT              (_GPIO_TIMER3_CC6ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER3_CC6ROUTE*/

/* Bit fields for GPIO_TIMER3 CDTI0ROUTE */
#define _GPIO_TIMER3_CDTI0ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER3_CDTI0ROUTE    */
#define _GPIO_TIMER3_CDTI0ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER3_CDTI0ROUTE             */
#define _GPIO_TIMER3_CDTI0ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER3_CDTI0ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER3_CDTI0ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER3_CDTI0ROUTE     */
#define GPIO_TIMER3_CDTI0ROUTE_PORT_DEFAULT           (_GPIO_TIMER3_CDTI0ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER3_CDTI0ROUTE*/
#define _GPIO_TIMER3_CDTI0ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER3_CDTI0ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER3_CDTI0ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER3_CDTI0ROUTE     */
#define GPIO_TIMER3_CDTI0ROUTE_PIN_DEFAULT            (_GPIO_TIMER3_CDTI0ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER3_CDTI0ROUTE*/

/* Bit fields for GPIO_TIMER3 CDTI1ROUTE */
#define _GPIO_TIMER3_CDTI1ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER3_CDTI1ROUTE    */
#define _GPIO_TIMER3_CDTI1ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER3_CDTI1ROUTE             */
#define _GPIO_TIMER3_CDTI1ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER3_CDTI1ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER3_CDTI1ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER3_CDTI1ROUTE     */
#define GPIO_TIMER3_CDTI1ROUTE_PORT_DEFAULT           (_GPIO_TIMER3_CDTI1ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER3_CDTI1ROUTE*/
#define _GPIO_TIMER3_CDTI1ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER3_CDTI1ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER3_CDTI1ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER3_CDTI1ROUTE     */
#define GPIO_TIMER3_CDTI1ROUTE_PIN_DEFAULT            (_GPIO_TIMER3_CDTI1ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER3_CDTI1ROUTE*/

/* Bit fields for GPIO_TIMER3 CDTI2ROUTE */
#define _GPIO_TIMER3_CDTI2ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER3_CDTI2ROUTE    */
#define _GPIO_TIMER3_CDTI2ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER3_CDTI2ROUTE             */
#define _GPIO_TIMER3_CDTI2ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER3_CDTI2ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER3_CDTI2ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER3_CDTI2ROUTE     */
#define GPIO_TIMER3_CDTI2ROUTE_PORT_DEFAULT           (_GPIO_TIMER3_CDTI2ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER3_CDTI2ROUTE*/
#define _GPIO_TIMER3_CDTI2ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER3_CDTI2ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER3_CDTI2ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER3_CDTI2ROUTE     */
#define GPIO_TIMER3_CDTI2ROUTE_PIN_DEFAULT            (_GPIO_TIMER3_CDTI2ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER3_CDTI2ROUTE*/

/* Bit fields for GPIO_TIMER3 CDTI3ROUTE */
#define _GPIO_TIMER3_CDTI3ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER3_CDTI3ROUTE    */
#define _GPIO_TIMER3_CDTI3ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER3_CDTI3ROUTE             */
#define _GPIO_TIMER3_CDTI3ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER3_CDTI3ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER3_CDTI3ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER3_CDTI3ROUTE     */
#define GPIO_TIMER3_CDTI3ROUTE_PORT_DEFAULT           (_GPIO_TIMER3_CDTI3ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER3_CDTI3ROUTE*/
#define _GPIO_TIMER3_CDTI3ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER3_CDTI3ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER3_CDTI3ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER3_CDTI3ROUTE     */
#define GPIO_TIMER3_CDTI3ROUTE_PIN_DEFAULT            (_GPIO_TIMER3_CDTI3ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER3_CDTI3ROUTE*/

/* Bit fields for GPIO_TIMER3 CDTI4ROUTE */
#define _GPIO_TIMER3_CDTI4ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER3_CDTI4ROUTE    */
#define _GPIO_TIMER3_CDTI4ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER3_CDTI4ROUTE             */
#define _GPIO_TIMER3_CDTI4ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER3_CDTI4ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER3_CDTI4ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER3_CDTI4ROUTE     */
#define GPIO_TIMER3_CDTI4ROUTE_PORT_DEFAULT           (_GPIO_TIMER3_CDTI4ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER3_CDTI4ROUTE*/
#define _GPIO_TIMER3_CDTI4ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER3_CDTI4ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER3_CDTI4ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER3_CDTI4ROUTE     */
#define GPIO_TIMER3_CDTI4ROUTE_PIN_DEFAULT            (_GPIO_TIMER3_CDTI4ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER3_CDTI4ROUTE*/

/* Bit fields for GPIO_TIMER3 CDTI5ROUTE */
#define _GPIO_TIMER3_CDTI5ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER3_CDTI5ROUTE    */
#define _GPIO_TIMER3_CDTI5ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER3_CDTI5ROUTE             */
#define _GPIO_TIMER3_CDTI5ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER3_CDTI5ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER3_CDTI5ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER3_CDTI5ROUTE     */
#define GPIO_TIMER3_CDTI5ROUTE_PORT_DEFAULT           (_GPIO_TIMER3_CDTI5ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER3_CDTI5ROUTE*/
#define _GPIO_TIMER3_CDTI5ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER3_CDTI5ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER3_CDTI5ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER3_CDTI5ROUTE     */
#define GPIO_TIMER3_CDTI5ROUTE_PIN_DEFAULT            (_GPIO_TIMER3_CDTI5ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER3_CDTI5ROUTE*/

/* Bit fields for GPIO_TIMER3 CDTI6ROUTE */
#define _GPIO_TIMER3_CDTI6ROUTE_RESETVALUE            0x00000000UL                                /**< Default value for GPIO_TIMER3_CDTI6ROUTE    */
#define _GPIO_TIMER3_CDTI6ROUTE_MASK                  0x000F0003UL                                /**< Mask for GPIO_TIMER3_CDTI6ROUTE             */
#define _GPIO_TIMER3_CDTI6ROUTE_PORT_SHIFT            0                                           /**< Shift value for GPIO_PORT                   */
#define _GPIO_TIMER3_CDTI6ROUTE_PORT_MASK             0x3UL                                       /**< Bit mask for GPIO_PORT                      */
#define _GPIO_TIMER3_CDTI6ROUTE_PORT_DEFAULT          0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER3_CDTI6ROUTE     */
#define GPIO_TIMER3_CDTI6ROUTE_PORT_DEFAULT           (_GPIO_TIMER3_CDTI6ROUTE_PORT_DEFAULT << 0) /**< Shifted mode DEFAULT for GPIO_TIMER3_CDTI6ROUTE*/
#define _GPIO_TIMER3_CDTI6ROUTE_PIN_SHIFT             16                                          /**< Shift value for GPIO_PIN                    */
#define _GPIO_TIMER3_CDTI6ROUTE_PIN_MASK              0xF0000UL                                   /**< Bit mask for GPIO_PIN                       */
#define _GPIO_TIMER3_CDTI6ROUTE_PIN_DEFAULT           0x00000000UL                                /**< Mode DEFAULT for GPIO_TIMER3_CDTI6ROUTE     */
#define GPIO_TIMER3_CDTI6ROUTE_PIN_DEFAULT            (_GPIO_TIMER3_CDTI6ROUTE_PIN_DEFAULT << 16) /**< Shifted mode DEFAULT for GPIO_TIMER3_CDTI6ROUTE*/
/** @} End of group Parts */

#endif // SIMG301_GPIO_H
