/***************************************************************************//**
 * @brief Bluetooth Low Energy host stack internal types and functions
 *******************************************************************************
 * # License
...
enum sli_bt_command_id
{
    ...
    sli_bt_gap_get_max_connections_command_id = 0x06,
...
enum sli_bt_response_id
{
    ...
    sli_bt_gap_get_max_connections_response_id = 0x06,
...
enum sli_bt_event_id
{
    ...
    sli_bt_connection_channel_classification_event_id = 0x0f,
...
// -----------------------------------------------------------------------------
// Command and response structures for `bt` API
...
PACKSTRUCT( struct sl_bt_rsp_gap_get_max_connections_s
{
    uint16_t result;
    uint8_t num_connections;
});

typedef struct sl_bt_rsp_gap_get_max_connections_s sl_bt_rsp_gap_get_max_connections_t;
...
// -----------------------------------------------------------------------------
// BGAPI message union for all message types of `bt` API
...
PACKSTRUCT( struct sl_bt_packet {
  ...
  union {
    ...
    sl_bt_rsp_gap_get_max_connections_t                          rsp_gap_get_max_connections;
    ...
    sl_bt_evt_connection_channel_classification_t                evt_connection_channel_classification;
