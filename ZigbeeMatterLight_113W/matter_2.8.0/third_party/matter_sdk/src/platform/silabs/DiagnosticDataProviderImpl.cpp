...
{
    size_t totalHeapSize = sl_memory_get_total_heap_size();
    size_t usedHeapSize  = sl_memory_get_used_heap_size();
    size_t freeHeapSize  = (usedHeapSize <= totalHeapSize) ? (totalHeapSize - usedHeapSize) : 0;
